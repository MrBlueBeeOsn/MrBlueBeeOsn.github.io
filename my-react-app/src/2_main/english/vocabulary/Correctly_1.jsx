...
export default function Correctly_1() {
  ...
  <main className="image image2">
    ...
    <p className="text-indent-whole">Thường xuyên sử dụng từ này trong các cuộc hội thoại và bài viết.</p>
      ...
      <p className="margin-bottom-50 text-indent-whole">Sự khác biệt: Câu thứ hai <span className="highlight6">nhấn mạnh rằng câu trả lời</span> của anh ấy không chỉ là một câu trả lời mà còn <span className="highlight6">là một câu trả lời đúng.</span></p>
