...
export default function AccountReconciliation(): React.JSX.Element {
  ...
  <main className="image image2">
    ...
    <article>
      ...
      <h1 className="margin-y-50 text-center">What is account reconciliation?</h1>
      ...
      <h3 className="margin-y-50 text-center">Two Piggy Banks (General Ledger vs. Statement):</h3>
      ...
      <h3 className="margin-y-50 text-center">Finding the Difference (Discrepancies):</h3>
      ...
      <h3 className="margin-y-50 text-center">Fixing the Problem (Resolving Discrepancies):</h3>
      ...
      <h3 className="margin-y-50 text-center">Keeping Track (Regular Process):</h3>
      ...
      <h3 className="margin-y-50 text-center">Double Checking with the Bank (Statement):</h3>
      ...
      <h3 className="margin-y-50 text-center">Comparing the Books (Matching Records):</h3>
      ...
      <h3 className="margin-y-50 text-center">Finding Missing Lemons (Discrepancies):</h3>
      ...
      <h3 className="margin-y-50 text-center">Fixing the Mistake (Resolving Discrepancies):</h3>
      ...
      <h3 className="margin-y-50 text-center">Regular Checkup (Regular Process): </h3>
