...
export default function VietCumDongTuTiengAnh(): React.JSX.Element {
	...
	<main className="image image2">
		...
		<article>
			...
			{/* =============================
					Bước 2: Bổ sung từng lớp thời gian hành động từ phải sang trái
			============================= */}
			...
			<h3 className="margin-y-50 text-center">3. Thứ tự thời gian hành động chuẩn trong tiếng Anh (Modal – Perfect – Continuous – Passive)</h3>
			...
			<h3 className="margin-y-50 text-center">4. Lưu ý quan trọng khi áp dụng</h3>
				...
				<ul className="list-square">
					...
					<li>Khi đặt bút (hoặc gõ phím) thì <strong>luôn bắt đầu bằng hành động chính trước</strong> → <strong>rồi thêm từng thời gian hành động vào phía trước</strong> → đảm bảo không sai thứ tự.</li>

					<li>Phủ định “not” luôn đứng ngay sau thời gian hành động đầu tiên (hoặc sau modal).</li>

					<li>Với câu hỏi chỉ cần đảo thời gian hành động đầu tiên lên trước danh chủ sau khi đã xây xong cụm.</li>
			...
			<p>Dù trong đầu bạn nghĩ “đã đang sẽ không thể…” theo kiểu tiếng Việt (từ trái sang phải), chỉ cần <strong>luôn viết hành động chính trước</strong>, <strong>rồi bổ sung từng thời gian hành động một vào phía trước</strong> (tức viết từ phải sang trái), bạn sẽ luôn có động cụm tiếng Anh đúng thứ tự 100%, dù dài bao nhiêu lớp đi nữa. Đây chính là mẹo hay nhất dành riêng cho người Việt khi làm việc với thì tiếng Anh!</p>
