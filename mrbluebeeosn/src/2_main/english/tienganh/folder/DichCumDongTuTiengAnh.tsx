...
export default function DichCumDongTuTiengAnh(): React.JSX.Element {
	...
	<main className="image image2">
		...
		<article>
			...
			<p className="margin-top-20">Ví dụ: Trong cụm <strong>run quickly up the hill</strong>, hành động chính là <strong>run</strong>, còn <strong>quickly</strong> và <strong>up the hill</strong> là các ADverb và bổ ngữ. Khi đặt vào ngoặc đơn, ta có: <strong>run</strong> (<strong>quickly up the hill</strong>).</p>

			<p>Khi dịch sang tiếng Việt, cấu trúc này cần được đảo ngược để hành động đứng trước, còn các ADverb và bổ ngữ đứng sau, với các ADverb hoặc bổ ngữ được nhận diện từ dấu ngoặc đơn.</p>
			...
			{/* =============================
					Bước 1: Xác định hành động chính
			============================= */}
			...
			{/* =============================
					Bước 2: Đặt các ADverb hoặc bổ ngữ vào dấu ngoặc đơn
			============================= */}

			<div className="margin-y-15 text-border1 table-container">

				<h3 className="margin-y-50 text-center">Bước 2: Đặt các ADverb hoặc bổ ngữ vào dấu ngoặc đơn</h3>

				<p>Liệt kê các ADverb hoặc bổ ngữ đứng sau hành động chính và đặt chúng vào dấu ngoặc đơn trong cấu trúc động cụm. Các thành phần này sẽ được dịch sau hành động chính.</p>
			...
			{/* =============================
					Bước 3: Dịch hành động trước
			============================= */}

			<div className="margin-y-15 text-border1 table-container">

				<h3 className="margin-y-50 text-center">Bước 3: Dịch hành động trước</h3>

				<p>Dịch hành động chính sang tiếng Việt trước tiên.</p>
			...
			{/* =============================
					Bước 4: Dịch các ADverb hoặc bổ ngữ từ phải sang trái
			============================= */}

			<div className="margin-y-15 text-border1 table-container">

				<h3 className="margin-y-50 text-center">Bước 4: Dịch các ADverb hoặc bổ ngữ từ phải sang trái</h3>

				<p>Dịch các ADverb hoặc bổ ngữ trong dấu ngoặc đơn theo thứ tự từ phải sang trái để phù hợp với ngữ pháp tiếng Việt.</p>
