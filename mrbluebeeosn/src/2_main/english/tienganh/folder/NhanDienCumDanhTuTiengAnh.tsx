			...
			<div className="margin-y-15 text-border1 table-container">
				...
				<p className="margin-top-20">Bước 2 – Xác định What: tay phải: flower → hoa</p>
					...
					<ul className="list-square">
						...
						<li className="list-none">→ ADjective ý kiến (beautiful) → kích thước (big) → màu sắc (red) → NOUN chính (flower).</li>
			...
			<div className="margin-y-15 text-border1 table-container">
				...
				<p className="margin-top-20">Bước 2 – Xác định What: tay phải: cats → mèo</p>
					...
					<ul className="list-square">
						...
						<li className="list-none">→ số từ (three) → ý kiến (cute) → kích thước (small) → màu (black) → NOUN chính (cats).</li>
			...
			<div className="margin-y-15 text-border1 table-container">
				...
				<p className="margin-top-20">Bước 2 – Xác định What: tay phải: table → bàn</p>
					...
					<ul className="list-square">
						...
						<li className="list-none">→ mạo từ (an) → tuổi (old) → chất liệu (wooden) → NOUN chính (table).</li>
			...
			<div className="margin-y-15 text-border1 table-container">
				...
				<p className="margin-top-20">Bước 2 – Xác định What: tay phải: dresses → váy</p>
					...
					<ul className="list-square">
						...
						<li className="list-none">→ số từ → ý kiến → nguồn gốc → chất liệu → NOUN chính.</li>
			...
			<div className="margin-y-15 text-border1 table-container">
				...
				<p className="margin-top-20">Bước 2 – Xác định What: tay phải: laptop → laptop</p>
					...
					<ul className="list-square">
						...
						<li className="list-none">→ sở hữu → quan hệ → tuổi → NOUN chính.</li>
			...
			<div className="margin-y-15 text-border1 table-container">
				...
				<p className="margin-top-20">Bước 2 – Xác định What: tay phải: table → bàn</p>
					...
					<ul className="list-square">
						...
						<li className="list-none">→ mạo từ → kích thước → hình dạng → chất liệu → mục đích → NOUN chính.</li>
