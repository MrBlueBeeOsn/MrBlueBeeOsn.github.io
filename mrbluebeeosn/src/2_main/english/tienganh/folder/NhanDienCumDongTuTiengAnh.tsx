		...
		<article>
			...
			<p className="margin-top-20">Quy tắc vàng cực dễ nhớ:</p>
				...
				<ul className="list-square">
					...
					<li><strong>Tay phải</strong> = <strong>What</strong> (cái gì): hành động chính luôn nằm cuối cùng</li>
			...
			<p className="margin-top-20">Quy tắc tay trái – tay phải:</p>
				...
				<ul className="list-square">
					...
					<li><strong>Tay phải</strong> = <strong>What</strong>: hành động chính luôn nằm cuối cùng</li>
