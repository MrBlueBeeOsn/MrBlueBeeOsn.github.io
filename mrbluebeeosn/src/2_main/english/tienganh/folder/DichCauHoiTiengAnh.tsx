		...
		<article>
			...
			<p>Một câu hỏi tiếng Anh thường bao gồm:</p>
				...
				<ul className="list-square">
					...
					<li>[<strong>Thời ĐỘNG</strong>] (<strong>auxiliary verb</strong>): Như <strong>do</strong>, <strong>does</strong>, <strong>did</strong>, <strong>will</strong>, <strong>can</strong>, hỗ trợ cấu trúc ngữ pháp của câu hỏi, thường xuất hiện trong các câu hỏi có hành động hành động. Trong một số trường hợp, như câu hỏi với hành động <strong>to be</strong> (is, are, am), không có thời gian hành động mà <strong>to be</strong> đóng vai trò là hành động chính.</li>

					<li><strong>Chủ từ</strong> (<strong>subject</strong>): Thành phần thực hiện hành động, đứng sau hỏi từ và thời gian hành động (hoặc hành động chính nếu không có thời ĐỘNG).</li>

					<li><strong>ĐỘNG chính</strong> (<strong>main verb</strong>): Mang ý nghĩa chính của hành động hoặc trạng thái.</li>

					<li><strong>Các bổ ngữ hoặc TRẠNG</strong>: Bổ sung ý nghĩa về cách thức, thời gian, địa điểm, hoặc mức độ, thường đứng cuối câu.</li>
			...
			<h3 className="margin-y-50 text-center">Ví dụ:</h3>
				...
				<p className="margin-top-20">Trong câu [<strong>What</strong>] (<strong>is English</strong>)?, ta có:</p>
					...
					<ul className="list-square">
						...
						<li>ĐỘNG chính: <strong>is</strong> (không có thời ĐỘNG).</li>
			...
			<p className="margin-top-20">Khi dịch sang tiếng Việt, cấu trúc này được đảo ngược để chủ từ đứng trước, tiếp theo là thời gian hành động (nếu có), hành động chính, các bổ ngữ hoặc TRẠNG, và cuối cùng là hỏi từ.</p>
			...
			<div className="margin-y-15 text-border1 table-container">
				...
				<p>Xác định hỏi từ, thời gian hành động (nếu có), hành động chính, chủ từ, và các bổ ngữ hoặc TRẠNG.</p>
				...
				<p className="margin-top-20">Ví dụ khác: [<strong>Where</strong>] (<strong>does she</strong>) <strong>live now</strong>?</p>
					...
					<ul className="list-square">
						...
						<li>Thời ĐỘNG: <strong>does</strong>.</li>
						
						<li>Chủ từ: <strong>she</strong>.</li>

						<li>ĐỘNG chính: <strong>live</strong>.</li>

						<li>TRẠNG: <strong>now</strong>.</li>
			...
			<div className="margin-y-15 text-border1 table-container">
				...
				<p>Đặt hỏi từ trong dấu ngoặc vuông [] để đánh dấu nó sẽ được dịch cuối cùng. Đặt thời gian hành động (hoặc hành động chính nếu không có thời ĐỘNG) và chủ từ trong dấu ngoặc đơn () để dịch từ phải sang trái.</p>
			...
			{/* =============================
					Bước 4: Dịch thời gian hành động (nếu có), hành động chính, và các bổ ngữ hoặc TRẠNG
			============================= */}

			<div className="margin-y-15 text-border1 table-container">

				<h3 className="margin-y-50 text-center">Bước 4: Dịch thời gian hành động (nếu có), hành động chính, và các bổ ngữ hoặc TRẠNG</h3>

				<p>Dịch các thành phần trong dấu ngoặc đơn () từ phải sang trái (bắt đầu từ chủ từ, sau đó là thời gian hành động hoặc hành động chính), rồi tiếp tục với hành động chính (nếu chưa được dịch) và các bổ ngữ hoặc ADverb theo thứ tự tự nhiên trong tiếng Việt.</p>
				...
				<p className="margin-top-20">Ví dụ: Trong [<strong>Where</strong>] (<strong>does she</strong>) <strong>live now</strong>?</p>
					...
					<ul className="list-square">
						...
						<li>ĐỘNG chính: <strong>live</strong> → sống.</li>

						<li>TRẠNG: <strong>now</strong> → bây giờ.</li>
			...
			<p>Khi câu hỏi có bổ ngữ hoặc ADverb phức tạp hơn, bạn vẫn áp dụng nguyên tắc tương tự, chỉ đặt hỏi từ trong dấu ngoặc vuông [] và thời gian hành động (hoặc hành động chính) cùng chủ từ trong dấu ngoặc đơn (), còn các thành phần khác được dịch theo thứ tự tự nhiên trong tiếng Việt.</p>
			...
			<p className="margin-top-20">Ví dụ 1: [<strong>Why</strong>] (<strong>did he</strong>) <strong>run quickly to the station</strong>?</p>
				...
				<ul className="list-square">
					...
					<li>Thời ĐỘNG: <strong>did</strong> (thường không dịch trực tiếp, thể hiện qua thời quá khứ).</li>

					<li>ĐỘNG chính: <strong>run</strong> → chạy.</li>

					<li>TRẠNG và bổ ngữ: <strong>quickly</strong> (nhanh chóng), <strong>to the station</strong> (đến nhà ga).</li>
			...
			<p className="margin-top-20">Ví dụ 2: [<strong>How</strong>] (<strong>can they</strong>) <strong>solve the problem effectively</strong>?</p>
				...
				<ul className="list-square">
					...
					<li>Thời ĐỘNG: <strong>can</strong> → có thể.</li>

					<li>ĐỘNG chính: <strong>solve</strong> → giải quyết.</li>
			...
			<p className="margin-top-20">Ví dụ 3: [<strong>When</strong>] (<strong>will she</strong>) <strong>arrive at the airport</strong>?</p>
				...
				<ul className="list-square">
					...
					<li>Thời ĐỘNG: <strong>will</strong> → sẽ.</li>

					<li>ĐỘNG chính: <strong>arrive</strong> → đến.</li>
			...
			<h3 className="margin-y-50 text-center">4. Lưu ý khi dịch</h3>
				...
				<ul className="list-square">
					...
					<li>ĐỘNG chính (như <strong>is</strong>, <strong>are</strong>, <strong>am</strong> trong vai trò hành động <strong>to be</strong>, hoặc các hành động hành động như <strong>run</strong>, <strong>solve</strong>) mang ý nghĩa chính và được dịch rõ ràng.</li>

					<li>Trong các câu hỏi như [<strong>What</strong>] (<strong>is English</strong>)?, <strong>is</strong> là hành động chính, không phải thời ĐỘNG.</li>

				</ul>

				<p className="margin-top-20"><strong>So sánh với cách khác</strong>: Một cách tiếp cận khác là đặt cả hỏi từ và thời ĐỘNG/ĐỘNG chính vào cùng dấu ngoặc đơn, ví dụ: (<strong>What is</strong>) <strong>English</strong>?. Cách này đơn giản hơn nhưng ít rõ ràng trong việc tách hỏi từ để dịch cuối cùng, đặc biệt với các câu hỏi phức tạp. Cách [<strong>What</strong>] (<strong>is English</strong>)? được khuyến nghị vì nó tách biệt hỏi từ, giúp dễ dàng áp dụng nguyên tắc dịch hỏi từ ở cuối câu.</p>

				<p><strong>Cấu trúc câu hỏi</strong>: Câu hỏi tiếng Anh thường có dạng <strong>hỏi từ</strong> + [<strong>Thời ĐỘNG</strong>]/<strong>ĐỘNG chính</strong> + <strong>chủ từ</strong> + <strong>ĐỘNG chính</strong> (nếu có) + <strong>bổ ngữ</strong>/<strong>TRẠNG</strong>. Khi đặt vào dấu ngoặc, hỏi từ nằm trong dấu [] và thời gian hành động cùng chủ từ trong dấu (), nhưng khi dịch, hỏi từ được đặt ở cuối câu.</p>
				...
				<p><strong>Bổ ngữ phức tạp</strong>: Với các câu hỏi có bổ ngữ dài (như cụm GIỚI hoặc câu con), chỉ đặt hỏi từ trong [] và thời ĐỘNG/chủ từ trong (), còn các bổ ngữ được dịch sau chủ từ và hành động chính theo cách thông thường.</p>
