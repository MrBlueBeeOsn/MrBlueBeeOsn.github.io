		...
		<article>
			...
			<h3 className="margin-y-50 text-center">4. Lưu ý khi dịch</h3>
				...
				<ul className="list-square">
					...
					<li>Trong các câu hỏi như [<strong>What</strong>] (<strong>is English</strong>)?, <strong>is</strong> là hành động chính, không phải thời động cơ.</li>
				...
				<p><strong>Bổ ngữ phức tạp</strong>: Với các câu hỏi có bổ ngữ dài (như cụm giới cơ hoặc câu con), chỉ đặt hỏi từ trong [] và thời động cơ/chủ từ trong (), còn các bổ ngữ được dịch sau chủ từ và hành động chính theo cách thông thường.</p>
