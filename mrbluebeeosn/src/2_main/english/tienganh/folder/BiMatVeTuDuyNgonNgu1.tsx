...
export default function BiMatVeTuDuyNgonNgu1(): React.JSX.Element {
	...
	<main className="image image2">
		...
		<article>
			...
			{/* 1. Nguyên lý "Phác thảo": ADjective + NOUN (Cái nhìn định tính) */}

			<h3 className="margin-y-50 text-center">1. Nguyên lý "Phác thảo": ADjective + NOUN (Cái nhìn định tính)</h3>
			...
			{/* 2. Nguyên lý "Đạo diễn": ADverb + Hành động (Sắc thái hành động) */}

			<h3 className="margin-y-50 text-center">2. Nguyên lý "Đạo diễn": ADverb + Hành động (Sắc thái hành động)</h3>

			<p>Nếu ADjective là màu sắc, thì ADverb chính là <strong>nhạc nền</strong>. Tại sao họ nói "<strong>He QUIETLY opened the door</strong>"?</p>
			...
			<p><strong>Tư duy đột phá</strong>: ADverb đứng trước để <strong>thiết lập bầu không khí</strong>.</p>
