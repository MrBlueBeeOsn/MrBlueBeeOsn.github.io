		...
		<article>
			...
			<h3 className="margin-y-50 text-center">2. Học thế nào cho nhớ</h3>
				...
				<ul className="list-square">
					...
					<li className="margin-top-20 list-none">Lấy một đoạn tiếng Anh bất kỳ, gạch chân hành động chính. Đếm được 1 hành động chia thời = 1 câu con. Luyện 5 phút mỗi ngày, mắt bạn sẽ tự động thấy khung.</li>
