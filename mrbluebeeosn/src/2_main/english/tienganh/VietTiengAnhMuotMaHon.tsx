...
export default function VietTiengAnhMuotMaHon(): React.JSX.Element {
	...
	<main className="image image2">
		...
		<article>
			...
			<p>Khi não bạn quen suy nghĩ theo kiểu tiếng Việt, việc buộc phải “nghĩ ADjective trước” sẽ gây gián đoạn dòng chảy ý tưởng. Bạn chưa kịp nghĩ ra từ “beautiful” thì đã muốn viết “house” rồi. Kết quả: khựng!</p>
			...
			<div className="margin-y-15 text-border1 table-container">
				...
				<h3 className="margin-y-50 text-center">1. Với danh cụm</h3>
					...
					<p>Khi viết nháp, bạn cứ để trống một khoảng rồi viết NOUN trước:</p>
