		...
		<article>
			...
			<h4 className="margin-y-30">Thử Thách 7 Ngày “Nói Tiếng Anh Mượt Hơn Hẳn” – Bắt Đầu Ngay Hôm Nay!</h4>
				...
				<ul className="list-square">
					...
					<li><strong>Ngày 1–2</strong>: Chọn 3 động từ yêu thích (work, eat, go) – viết hoặc nói 5 câu cho mỗi dạng.</li>
					...
					<li><strong>Ngày 5–6</strong>: Nói về “đang làm”: Ghi âm “What am I doing right now?”.</li>
