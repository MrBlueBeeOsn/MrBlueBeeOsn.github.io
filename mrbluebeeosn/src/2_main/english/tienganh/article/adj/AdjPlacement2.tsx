...
export default function AdjPlacement2(): React.JSX.Element {
	...
	<main className="image image2">
		...
		<article>
			...
			<p className="margin-top-20 text-indent-whole"><strong>Tính Cụm dạng hành động chủ động</strong> (-ing): [playing football]</p>
			...
			<p className="margin-top-20 text-indent-whole"><strong>Tính Cụm dạng hành động bị động</strong> (-v3/-ed): [repaired yesterday]</p>
			...
			<p className="margin-top-20 text-indent-whole"><strong>Tính Cụm dạng Giới Cụm</strong> [<strong>Prepositional Phrase</strong>]: [in the blue dress]</p>
