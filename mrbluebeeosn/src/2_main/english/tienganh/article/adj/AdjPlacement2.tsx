		...
		<article>
			...
			<p className="margin-top-20"><strong>Ba khái niệm hình thái</strong> (cấu trúc bên trong):</p>
				...
				<ul className="list-square">
					...
					<li>[run], [think], [be]</li>
					<li className="margin-bottom-20 list-none">– [Rễ Động Cơ][Root Verb Base]</li>
					...
					<li className="list-none">– [Liên Câu][Conjunctional Base]</li>
			...
			<p className="text-indent-whole"><strong>Ví dụ 1</strong>: [<strong>Danh Cơ</strong>][<strong>Noun Base</strong>]: [Running]</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">Hình thái: [Running] - [Tiếp Động Cơ][Progressive Verb Base] hình thành từ khối [Rễ Động Cơ][Root Verb Base] nguyên bản "Run" mặc thêm (kết hợp) hậu tố "-ing" để thay đổi diện mạo bên ngoài thành một khối cấp độ [Cơ][Base].</li>
			...
			<p className="margin-top-20 text-indent-whole"><strong>Ví dụ 2</strong>: [<strong>Danh Cụm</strong>][<strong>Noun Phrase</strong>]: [to paint landscapes]</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">Hình thái: [to paint landscapes] – [Hạt Thuần Động Cụm][Particle Bare Verb Phrase] gồm [Hạt Thuần Động Cơ][Particle Bare Verb Base] to paint và thành phần đi kèm landscapes.</li>
			...
			<p className="margin-top-20 text-indent-whole"><strong>Ví dụ 3</strong>: [<strong>Danh Câu</strong>][<strong>Noun Clause</strong>]: [what you whispered yesterday]</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">Hình thái: [what you whispered yesterday] – [Liên Câu][Conjunctional Base] bên trong có cặp you + whispered.</li>
			...
			<p className="margin-top-20 text-indent-whole">Khi một [Động Câu] được lồng bên trong một Động Cụm, ta có một [Danh Cụm] phân tầng – cấu trúc cực kỳ phổ biến trong tiếng Anh đẳng cấp.</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">Hình thái tầng trong: {'{where she hides the key}'} – [Liên Câu][Conjunctional Base] → chức năng [Danh Câu][Noun Clause].</li>
			...
			<p className="text-indent-whole"><strong>Ví dụ 1</strong>: [<strong>Tính Cơ</strong>][<strong>Adjective Base</strong>]: [sparkling]</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">Hình thái: [sparkling] - [Tiếp Động Cơ][Progressive Verb Base] hình thành từ khối [Rễ Động Cơ][Root Verb Base] nguyên bản "spark" mặc thêm (kết hợp) hậu tố "-ing" để thay đổi diện mạo bên ngoài thành một khối cấp độ [Cơ][Base].</li>
			...
			<p className="margin-top-20 text-indent-whole"><strong>Ví dụ 3</strong>: [<strong>Tính Câu</strong>][<strong>Adjective Clause</strong>]: [which I bought yesterday]</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">Hình thái: [which I bought yesterday] – [Liên Câu][Conjunctional Base] bên trong có cặp I + bought.</li>
			...
			<p className="margin-top-20 text-indent-whole"><strong>Ví dụ 2</strong>: [<strong>Trạng Cụm</strong>][<strong>Adverb Phrase</strong>]: [to pass the exam]</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">Hình thái: [to pass the exam] – [Hạt Thuần Động Cụm][Particle Bare Verb Phrase] dạng nguyên mẫu.</li>
			...
			<p className="margin-top-20 text-indent-whole"><strong>Ví dụ 3</strong>: [<strong>Trạng Câu</strong>][<strong>Adverb Clause</strong>]: [because it was raining heavily]</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">Hình thái: [because it was raining heavily] – [Liên Câu][Conjunctional Base] bên trong có cặp it + was raining.</li>
			...
			<p className="margin-top-20 text-indent-whole">[<strong>Tính Cụm</strong>] <strong>dạng hành động chủ động</strong> (-ing): [playing football]</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">Hình thái: [playing football] – [Tiếp Động Cụm][Progressive Verb Phrase] dạng -ing.</li>
			...
			<p className="margin-top-20 text-indent-whole">[<strong>Tính Cụm</strong>] <strong>dạng hành động bị động</strong> (-v3/-ed): [repaired yesterday]</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">Hình thái: [repaired yesterday] – [Hoàn Động Cụm][Perfect Verb Phrase] dạng *-ed*.</li>
			...
			<p className="margin-top-20 text-indent-whole">Ví dụ 1:</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">Hình thái: [which I bought] – [Liên Câu][Conjunctional Base] bên trong có cấu trúc O + S + V.</li>
			...
			<p className="margin-top-20 text-indent-whole">Ví dụ 2:</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">Hình thái: [that she recommended] – [Liên Câu][Conjunctional Base] bên trong có cấu trúc O + S + V.</li>
			...
			<p className="margin-top-20 text-indent-whole">Ví dụ 3:</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">Hình thái: [who we admired] – [Liên Câu][Conjunctional Base] bên trong có cấu trúc O + S + V.</li>
			...
			<h4 className="margin-y-40">Ví dụ tiếng Anh với [Tính Câu] và Tính Cụm</h4>
				...
				<ul className="list-square">
					...
					<li className="list-none">Hình thái: [who explains slowly] – [Liên Câu][Conjunctional Base] bên trong có cặp who + explains.</li>
					...
					<li className="margin-bottom-20 list-none">Người giáo viên [<strong>giảng chậm</strong>] thì rất kiên nhẫn.</li>
					<li className="list-none">Hình thái: [explaining slowly] – [Tiếp Động Cụm][Progressive Verb Phrase] dạng -ing.</li>
			...
			<h4 className="margin-y-40">Ví dụ tiếng Việt – Sự tương đồng tự nhiên</h4>
				...
				<ul className="list-square">
					...
					<li className="list-none">Hình thái: [đội mũ đen] – [Tiếp Động Cụm][Progressive Verb Phrase] gồm [Tiếp Động Cơ][Progressive Verb Base] đội + thành phần đi kèm mũ đen.</li>
					...
					<li className="list-none">Hình thái: [đang hát kia] – [Tiếp Động Cụm][Progressive Verb Phrase] dạng đang + [Động Cơ] hát + chỉ định kia.</li>
			...
			<p className="margin-top-20 text-indent-whole"><strong>Câu gốc</strong>: [Learning]</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">[Learning] – [Tiếp Động Cơ][Progressive Verb Base] → [Danh Cơ][Noun Base] đóng vai trò [Danh Chủ] (thành phần đứng đầu câu).</li>
			...
			<p className="margin-top-20 text-indent-whole"><strong>Paraphrase 1</strong> – <strong>thay bằng một Danh Cụm</strong> [<strong>Noun Phrase</strong>] <strong>khác</strong>: [To swim every morning]</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">[To swim every morning] – [Hạt Thuần Động Cụm][Particle Bare Verb Phrase] dạng to + thành phần đi kèm → [Danh Cụm][Noun Phrase] – vẫn đóng vai trò Danh Chủ.</li>
			...
			<p className="margin-top-20 text-indent-whole"><strong>Paraphrase 2</strong> – <strong>thay bằng một Danh Câu</strong> [<strong>Noun Clause</strong>] <strong>khác</strong>: [What you do before breakfast]</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">[What you do before breakfast] – [Liên Câu][Conjunctional Base] → [Danh Câu][Noun Clause] – vẫn đóng vai trò Danh Chủ.</li>
			...
			<p className="margin-top-20 text-indent-whole"><strong>Câu gốc</strong>: [who lives next door]</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">[who lives next door] – [Liên Câu][Conjunctional Base] → [Tính Câu][Adjective Clause] – bổ nghĩa cho The man.</li>
			...
			<p className="margin-top-20 text-indent-whole"><strong>Paraphrase</strong> – <strong>thay bằng một Tính Cụm</strong> [<strong>Adjective Phrase</strong>]: [living next door]</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">[living next door] – [Tiếp Động Cụm][Progressive Verb Phrase] rút gọn → [Tính Cụm][Adjective Phrase] – vẫn bổ nghĩa cho The man.</li>
			...
			<p className="margin-top-20 text-indent-whole"><strong>Câu gốc</strong>: [because he worked hard]</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">[because he worked hard] – [Liên Câu][Conjunctional Base] → [Trạng Câu][Adverb Clause] chỉ nguyên nhân.</li>
			...
			<p className="margin-top-20 text-indent-whole"><strong>Paraphrase</strong> – <strong>thay bằng Trạng Cụm</strong> [<strong>Adverb Phrase</strong>]: [by working hard]</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">[by working hard] – [Giới Cụm][Prepositional Phrase] dạng [Giới Cụm] + [Tiếp Động Cơ][Progressive Verb Base] -ing → [Trạng Cụm][Adverb Phrase] – vẫn chỉ nguyên nhân/cách thức.</li>
			...
			<p className="margin-top-20"><strong>Bước 1</strong>: <strong>Viết một câu có chứa một Tính Câu</strong> [<strong>Adjective Clause</strong>]: [who explains slowly]</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">[who explains slowly] – [Liên Câu][Conjunctional Base] → [Tính Câu][Adjective Clause].</li>
			...
			<p className="margin-top-20"><strong>Bước 2</strong>: <strong>Paraphrase bằng cách thay [Tính Câu] đó bằng một Tính Cụm</strong> [<strong>Adjective Phrase</strong>]: [explaining slowly]</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">[explaining slowly] – [Tiếp Động Cụm][Progressive Verb Phrase] → [Tính Cụm][Adjective Phrase].</li>
