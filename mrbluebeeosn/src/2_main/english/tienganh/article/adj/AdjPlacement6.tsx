...
export default function AdjPlacement6(): React.JSX.Element {
	...
	<main className="image image2">
		...
		<article>
			...
			<p className="text-indent-whole"><strong>Gợi ý thực hành</strong>: khi viết luận, dùng câu con trạng ngữ để dẫn dắt luận điểm, rồi quay lại với NOUN chính và câu con ADjective để minh họa.</p>
			...
			<h3 className="margin-y-50 text-center">5. Những lỗi thường gặp và cách tránh</h3>
				...
				<ul className="list-square">
					...
					<li><strong>Dùng PROnoun quan hệ không phù hợp</strong></li>
			...
			<p className="text-indent-whole">Mỗi ngày chọn 3 câu tiếng Việt bạn hay dùng, dịch sang tiếng Anh theo mẫu NOUN → Mô tả, rồi ghép thành một đoạn 6–8 câu dùng cả ba câu con.</p>
