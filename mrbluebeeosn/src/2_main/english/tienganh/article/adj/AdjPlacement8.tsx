...
export default function AdjPlacement8(): React.JSX.Element {
	...
	<main className="image image2">
		...
		<article>
			...
			<p>Vì ở tầng cao hơn, tiếng Anh không nhồi ADjective lên trước. Nó làm đúng như tiếng Việt: </p>

			<p className="margin-y-20 text-indent-whole"><strong>Nêu NOUN trước</strong>, rồi <strong>thả cả thế giới mô tả theo sau</strong>.</p>
			...
			<p>Lấy một NOUN bất kỳ trong công việc: <strong>the proposal</strong>, <strong>the decision</strong>, <strong>the risk</strong>.</p>
