...
export default function AdjPlacement8(): React.JSX.Element {
	...
	<main className="image image2">
		...
		<article>
			...
			<p>Vì ở tầng cao hơn, tiếng Anh không nhồi tính từ lên trước. Nó làm đúng như tiếng Việt: </p>

			<p className="margin-y-20 text-indent-whole"><strong>Nêu danh từ trước</strong>, rồi <strong>thả cả thế giới mô tả theo sau</strong>.</p>
			...
			<p className="text-indent-whole">Đây là <strong>mệnh đề tính từ</strong>. Nó không đứng một mình, nó <strong>bám vào danh từ</strong> và kể chuyện về danh từ đó.</p>
			...
			<p className="margin-top-20 text-indent-whole">Khi đã quen đặt <strong>Adjective Clause sau danh từ</strong>, việc rút gọn trở thành phản xạ:</p>
			...
			<p className="text-indent-whole">Đây là bước nhảy vọt. <strong>Noun Clause</strong> biến cả một ý tưởng thành một danh từ.</p>
			...
			<p className="margin-y-40 text-indent-whole"><strong>Đặt nguyên khối ý tưởng lên trước</strong> hoặc <strong>sau động từ chính</strong>.</p>
			...
			<p>Trong khu vực, nhiều người học phải vật lộn để bỏ thói quen nhồi mọi thứ lên trước danh từ.</p>
			...
			<p><strong>Bạn thấy danh từ</strong>, <strong>bạn thấy phần mô tả ngay sau</strong>.</p>
			...
			<p>Lấy một danh từ bất kỳ trong công việc: <strong>the proposal</strong>, <strong>the decision</strong>, <strong>the risk</strong>.</p>
