		...
		<article>
			...
			<p className="margin-top-20 text-indent-whole"><strong>Cấp độ Cơ</strong> – [<strong>NOUN HEAD</strong>][<strong>DANH LÕI</strong>]: [Running]</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">Chức năng: [Running] - [SUBject HEAD][CHỦ LÕI] đứng đầu câu, là cái được khẳng định là [is fun]</li>
			...
			<p className="text-indent-whole"><strong>Câu gốc</strong>: [Running]</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">Chức năng: [Running] - [SUBject HEAD][CHỦ LÕI] làm chủ thể của câu, cái được khẳng định là thư giãn</li>
			...
			<h3 className="margin-y-50 text-center">4. LỘ TRÌNH LUYỆN TẬP</h3>
				...
				<ul className="list-square">
					...
					<li className="margin-bottom-20 list-none">[Swimming] - [SUBject HEAD][CHỦ LÕI] đứng đầu câu, là cái được nói đến</li>
