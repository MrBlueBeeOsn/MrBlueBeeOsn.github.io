	...
	<main className="image image2">
		...
		<article>
			...
			<p>Để bẻ khóa tiếng Anh nâng cao, người học cần nhìn nhận một khối biểu hiện dựa trên <strong>Hình thái biểu hiện</strong> của nó trước, sau đó mới xác định <strong>Chức năng</strong> dựa vào vị trí đứng trong câu. Hệ thống này được đồng bộ hóa một cách nhất quán theo hai trục:</p>
				...
				<ul className="list-square">
					...
					<li><strong>Chiều dọc</strong> – <strong>4 Cấp độ Hình thái</strong>: [VERB][ĐỘNG] → [VERB PHRASE][ĐỘNG CỤM] → [prepoSITional PHRASE][GIỚI CỤM] → [conJUNCtional CLAUSE][LIÊN CÂU]. Người học khi nhìn vào một câu chỉ cần nhận diện khối biểu hiện đang ở hình thái nào.</li>
			...
			<p className="margin-top-20">Từ sự giao thoa này, chúng ta có sự phân cấp vận hành tiếng Anh toàn diện dưới đây:</p>
				...
				<ul className="list-square">
					...
					<li><strong>Ở cấp độ</strong> [<strong>VERB</strong>][<strong>ĐỘNG</strong>]: Sinh ra [NOUN][DANH], [ADjective][TÍNH], [ADVERB][TRẠNG].</li>
      ...
      <p className="text-indent-whole">Nhóm tình huống ép buộc, chắc chắn: will (cam kết), shall (chắc chắn), can (năng lực), must (ép buộc), have to (bắt buộc), may (khả năng).</p>
        ...
        <ul className="list-square">
          ...
          <li value="1">[<strong>ROOT VERB</strong>][<strong>RỄ ĐỘNG</strong>]: ANalyze, INnovate, transFORM</li>
          ...
          <li value="6">[<strong>BARE VERB</strong>][<strong>THUẦN ĐỘNG</strong>]: ANalyze, INnovate, transFORM</li>
          ...
          <li value="7">[<strong>PARTicle BARE VERB</strong>][<strong>HẠT THUẦN ĐỘNG</strong>]: to ANalyze, to transFORM</li>
          ...
          <li value="11">[<strong>PAST TENSE VERB</strong>][<strong>QUÁ THỜI ĐỘNG</strong>], [<strong>3RD-PERson PRESent VERB</strong>][<strong>BA HIỆN ĐỘNG</strong>]: ANalyzed, ANalyzes, transFORMS</li>
          ...
          <li value="14">[<strong>TENSE PRESent PARTiciple VERB</strong>][<strong>THỜI HIỆN TIẾP ĐỘNG</strong>]: is ANalyzing, was transFORMing</li>
          ...
          <li value="15">[<strong>TENSE PAST PARTiciple VERB</strong>][<strong>THỜI QUÁ HOÀN ĐỘNG</strong>]: has ANalyzed, had transFORMED</li>
          ...
          <li value="16">[<strong>TENSE PERfect PRESent PARTiciple VERB</strong>][<strong>THỜI HOÀN HIỆN TIẾP ĐỘNG</strong>]: has been ANalyzing, had been transFORMing</li>
          <li className="list-none">Sự hợp nhất tuyến tính giữa ba lớp năng lượng [Thời] gian, [Hoàn] thành và [Tiếp] diễn.</li>
			...
			<p className="margin-top-20">Khi bất kỳ họ [VERB][ĐỘNG] nào (thuộc nhóm 16 mục trên) kéo theo các [OBject PROnoun][TÂN ĐẠI], [ADVERB][TRẠNG], [ADverb PHRASE][TRẠNG CỤM], hoặc [ADverb CLAUSE][TRẠNG CÂU] phía sau, toàn khối đó tự động chuyển đổi cấu trúc nội bộ và tái dán nhãn thành dạng [PHRASE][CỤM] tương ứng của chính nó.</p>
			
				<ul className="list-square">
			
					<li>Ví dụ 1: upGRADing [PRESent PARTiciple VERB][HIỆN TIẾP ĐỘNG] + the SYStem [OBject PROnoun][TÂN ĐẠI]</li>
					<li className="margin-bottom-20 list-none">→ upGRADing the SYStem [PRESent PARTiciple VERB PHRASE][HIỆN TIẾP ĐỘNG CỤM].</li>
			
					<li>Ví dụ 2: to coORdinate [PARTicle BARE VERB][HẠT THUẦN ĐỘNG] + efFIciently [ADVERB][TRẠNG]</li>
			...
			<h4 className="margin-y-40">1. Hình thái [ĐỘNG][VERB]</h4>
			...
			<p className="margin-top-20 text-indent-whole" id="NOUN-BASE"><strong>Ví dụ 1a</strong>: <strong>Sinh ra</strong> [<strong>DANH</strong>][<strong>NOUN</strong>] <strong>làm khối</strong> [<strong>SUBject PROnoun</strong>][<strong>CHỦ ĐẠI</strong>]</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">Hình thái: Khối [JOGging] - [PRESent PARTiciple VERB][HIỆN TIẾP ĐỘNG] hình thành từ khối [ROOT VERB][RỄ ĐỘNG] nguyên bản "JOG" mặc thêm hậu tố "-ing" để thay đổi diện mạo bên ngoài thành một khối cấp độ [BASE][CƠ] đại diện cho một hành động biểu hiện khối cô đọng.</li>
			
					<li className="list-none">Chức năng: Khối [JOGging] - [NOUN][DANH] đóng vai trò làm [SUBject PROnoun][CHỦ ĐẠI] thực hiện hành động cho cả khối chịu sự quản lý thời gian của [3RD-PERson PRESent VERB][BA HIỆN ĐỘNG] "STRENGTHens".</li>
			
				</ul>

			
			<p className="margin-top-20 text-indent-whole"><strong>Ví dụ 1b</strong>: <strong>Sinh ra</strong> [<strong>DANH</strong>][<strong>NOUN</strong>] <strong>làm khối</strong> [<strong>OBject PROnoun</strong>][<strong>TÂN ĐẠI</strong>]</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">Hình thái: Khối [SWIMming] - [PRESent PARTiciple VERB][HIỆN TIẾP ĐỘNG] hình thành từ khối [ROOT VERB][RỄ ĐỘNG] nguyên bản "SWIM" mặc thêm hậu tố "-ing" để thay đổi diện mạo bên ngoài thành một khối cấp độ [BASE][CƠ] đại diện cho một hành động biểu hiện khối cô đọng.</li>
			
					<li className="list-none">Chức năng: Khối [SWIMming] - [NOUN][DANH] đóng vai trò làm [OBject PROnoun][TÂN ĐẠI] chịu sự điều phối trực tiếp của [3RD-PERson PRESent VERB][BA HIỆN ĐỘNG] "enJOYS".</li>
			
				</ul>
			
			
			<p className="margin-top-20 text-indent-whole" id="ADjective-BASE"><strong>Ví dụ 2</strong>: <strong>Sinh ra</strong> [<strong>ADjective</strong>][<strong>TÍNH</strong>]:</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">Hình thái: Khối [CUStomized] - [PAST PARTiciple VERB][QUÁ HOÀN ĐỘNG] hình thành từ khối [ROOT VERB][RỄ ĐỘNG] nguyên bản "CUStomize" mặc thêm hậu tố "-ed" để thay đổi diện mạo bên ngoài thành một khối cấp độ [BASE][CƠ] mang đặc tính bị động, hoàn tất.</li>
			
					<li className="list-none">Chức năng: Khối [CUStomized] - [ADjective][TÍNH] đứng ngay trước một thực thể để biểu thị đặc tính và bổ nghĩa cho thực thể đó.</li>
			
				</ul>
			
			
			<p className="margin-top-20 text-indent-whole" id="ADverb-BASE"><strong>Ví dụ 3</strong>: <strong>Sinh ra</strong> [<strong>ADVERB</strong>][<strong>TRẠNG</strong>]:</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">Hình thái: Khối [unexPECtedly] - [MODified ADVERB][DIỆN TRẠNG] hình thành từ khối [ROOT VERB][RỄ ĐỘNG] nguyên bản "exPECT" mặc thêm (kết hợp) tiền tố phủ định "un-" cùng tổ hợp các hậu tố biến đổi trạng thái "-ed" và "-ly" để thay đổi diện mạo bên ngoài thành một khối cấp độ [BASE][CƠ] biểu thị hoàn cảnh trạng thái đặc biệt.</li>
			
					<li className="list-none">Chức năng: Khối [unexPECtedly] - [ADVERB][TRẠNG] đứng trước để biểu thị mức độ, tính chất bối cảnh và bổ nghĩa trực tiếp cho từ mô tả đặc tính nhanh đứng liền phía sau.</li>
			...
			<p className="margin-top-20 text-indent-whole" id="NOUN-PHRASE"><strong>Ví dụ 1a</strong>: <strong>Sinh ra</strong> [<strong>DANH CỤM</strong>][<strong>NOUN PHRASE</strong>] <strong>làm khối</strong> [<strong>SUBject PROnoun</strong>][<strong>CHỦ ĐẠI</strong>]</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">Hình thái: Khối [to seCURE this CONtract] - [PARTicle BARE VERB PHRASE][HẠT THUẦN ĐỘNG CỤM] bắt đầu bằng [PARTicle BARE VERB][HẠT THUẦN ĐỘNG] "to seCURE" kéo theo một [OBject PROnoun][TÂN ĐẠI] phía sau.</li>
			...
			<p className="margin-top-20 text-indent-whole"><strong>Ví dụ 1b</strong>: <strong>Sinh ra</strong> [<strong>DANH CỤM</strong>][<strong>NOUN PHRASE</strong>] <strong>làm khối</strong> [<strong>OBject PROnoun</strong>][<strong>TÂN ĐẠI</strong>]</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">Hình thái: Khối [to LIQuidate the underperFORming ASsets] - [PARTicle BARE VERB PHRASE][HẠT THUẦN ĐỘNG CỤM] bắt đầu bằng [PARTicle BARE VERB][HẠT THUẦN ĐỘNG] "to LIQuidate" kéo theo một cụm [OBject PROnoun][TÂN ĐẠI] phức hợp phía sau.</li>
			
					<li className="list-none">Chức năng: Khối [to LIQuidate the underperFORming ASsets] - [NOUN PHRASE][DANH CỤM] làm khối [OBject PROnoun][TÂN ĐẠI] mục tiêu cần thực hiện, đứng sau chịu sự điều phối của [PAST TENSE VERB][QUÁ THỜI ĐỘNG] "reSOLVED".</li>
			...
			<p className="margin-top-20 text-indent-whole" id="ADverb-PHRASE"><strong>Ví dụ 3</strong>: <strong>Sinh ra</strong> [<strong>ADverb PHRASE</strong>][<strong>TRẠNG CỤM</strong>]:</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">Hình thái: Khối [to reFINE his LEADership STYLE] - [PARTicle BARE VERB PHRASE][HẠT THUẦN ĐỘNG CỤM] bắt đầu bằng [PARTicle BARE VERB][HẠT THUẦN ĐỘNG] "to reFINE" kéo theo một cụm [OBject PROnoun][TÂN ĐẠI] làm thành phần bổ trợ.</li>
			
					<li className="list-none">Chức năng: Khối [to reFINE his LEADership STYLE] - [ADverb PHRASE][TRẠNG CỤM] đứng cuối nhằm giải thích bối cảnh mục đích cho hành động tham gia được vận hành bởi [3RD-PERson PRESent VERB][BA HIỆN ĐỘNG] "atTENDS".</li>
			...
			<p className="text-indent-whole">Là khối không bắt đầu bằng một từ hành động, mà được định hình bắt đầu bằng một [prepoSITion][GIỚI] chỉ quan hệ kết hợp với một [OBject PROnoun][TÂN ĐẠI] phía sau.</p>
			...
			<p className="margin-top-20 text-indent-whole"><strong>Ví dụ 2</strong>: <strong>Sinh ra</strong> [<strong>ADverb PHRASE</strong>][<strong>TRẠNG CỤM</strong>]:</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">Hình thái: Khối [at MIDnight] - [prepoSITional PHRASE][GIỚI CỤM] bắt đầu bằng [prepoSITion][GIỚI] "at" liên kết quan hệ thời gian trực tiếp với [OBject PROnoun][TÂN ĐẠI] "MIDnight".</li>
			...
			<p className="text-indent-whole">Là đơn vị hành động mạnh mẽ nhất vì chứa cấu trúc khối hoàn chỉnh bên trong có [SUBject PROnoun][CHỦ ĐẠI] và các cấu hình [VERB][ĐỘNG] riêng biệt, đồng thời được dẫn dắt trực tiếp bởi một [conJUNCtion][LIÊN] tường minh:</p>
			...
			<p className="text-indent-whole" id="NOUN-CLAUSE"><strong>Ví dụ 1a</strong>: <strong>Sinh ra</strong> [<strong>NOUN CLAUSE</strong>][<strong>DANH CÂU</strong>] <strong>làm khối</strong> [<strong>SUBject PROnoun</strong>][<strong>CHỦ ĐẠI</strong>]</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">Hình thái: Khối  [HOW the TEAM seCURES the FUNding] - [conJUNCtional CLAUSE][LIÊN CÂU] bắt đầu bằng [conJUNCtion][LIÊN] "HOW" kết hợp với cấu trúc một khối hoàn chỉnh có [SUBject PROnoun][CHỦ ĐẠI] "the TEAM" và [3RD-PERson PRESent VERB][BA HIỆN ĐỘNG] "seCURES".</li>
			
					<li className="list-none">Chức năng: Khối  [HOW the TEAM seCURES the FUNding] - [NOUN CLAUSE][DANH CÂU] đóng vai trò làm [SUBject PROnoun][CHỦ ĐẠI] đứng trước điều phối [3RD-PERson PRESent VERB][BA HIỆN ĐỘNG] "reMAINS".</li>
			...
			<p className="text-indent-whole"><strong>Ví dụ 1b</strong>: <strong>Sinh ra</strong> [<strong>NOUN CLAUSE</strong>][<strong>DANH CÂU</strong>] <strong>làm khối</strong> [<strong>OBject PROnoun</strong>][<strong>TÂN ĐẠI</strong>]</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">Hình thái: Khối [that the ALgorithm posSESSED a BIas] - [conJUNCtional CLAUSE][LIÊN CÂU] bắt đầu bằng [conJUNCtion][LIÊN] "that" kết hợp với cấu trúc một khối hoàn chỉnh có [SUBject PROnoun][CHỦ ĐẠI] "the ALgorithm" và [PAST TENSE VERB][QUÁ THỜI ĐỘNG] "posSESSED".</li>
			
					<li className="list-none">Chức năng: Khối [that the ALgorithm posSESSED a BIas] - [NOUN CLAUSE][DANH CÂU] làm khối [OBject PROnoun][TÂN ĐẠI] chịu tác động trực tiếp đứng sau điều phối của [PAST TENSE VERB][QUÁ THỜI ĐỘNG] "reVEALED".</li>
			...
			<p className="margin-top-20 text-indent-whole" id="ADjective-CLAUSE"><strong>Ví dụ 2</strong>: <strong>Sinh ra</strong> [<strong>ADjective CLAUSE</strong>][<strong>TÍNH CÂU</strong>]:</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">Hình thái: Khối [which the TEAM dePLOYED LAST NIGHT] - [OBject PROnoun CLAUSE][TÂN ĐẠI CÂU] bắt đầu bằng [OBject PRONOUN][TÂN ĐẠI] quan hệ "which" kết hợp với cấu trúc một khối hoàn chỉnh có [SUBject PROnoun][CHỦ ĐẠI] "the TEAM" và [PAST TENSE VERB][QUÁ THỜI ĐỘNG] "dePLOYED".</li>
			...
			<p className="margin-top-20 text-indent-whole" id="ADverb-CLAUSE"><strong>Ví dụ 3</strong>: <strong>Sinh ra</strong> [<strong>ADverb CLAUSE</strong>][<strong>TRẠNG CÂU</strong>]:</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">Hình thái: Khối [un<strong>less</strong> the QUAlity STANdard imPROVES] - [conJUNCtional CLAUSE][LIÊN CÂU] bắt đầu bằng [conJUNCtion][LIÊN] điều kiện "un<strong>less</strong>" kết hợp với cấu trúc khối hoàn chỉnh có [SUBject PROnoun][CHỦ ĐẠI] "the QUAlity STANdard" và [3RD-PERson PRESent VERB][BA HIỆN ĐỘNG] "imPROVES".</li>
			...
			<p className="margin-top-20"><strong>Ví dụ 1</strong>: [<strong>NOUN CLAUSE</strong>][<strong>DANH CÂU</strong>]:</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">Hình thái: Khối [the BOARD would apPROVE the BUDget] - [ZEro-conJUNCtional CLAUSE][ẨN-LIÊN CÂU] lồng ghép trực tiếp đứng sau hành động chính mà không cần sự hỗ trợ của [conJUNCtion][LIÊN] "that".</li>
			
					<li className="list-none">Chức năng: Khối [the BOARD would apPROVE the BUDget] thực thi chức năng [NOUN CLAUSE][DANH CÂU] làm nhiệm vụ của một [OBject PROnoun][TÂN ĐẠI] chịu tác động trực tiếp đứng sau sự điều phối của [PAST TENSE VERB][QUÁ THỜI ĐỘNG] asSUMED.</li>
			...
			<p className="margin-top-20"><strong>Ví dụ 3</strong>: [<strong>ADverb CLAUSE</strong>][<strong>TRẠNG CÂU</strong>]:</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">Hình thái: Khối [the FASter the CHEMical reACTS] - [ZEro-conJUNCtional CLAUSE][ẨN-LIÊN CÂU] mang cấu trúc so sánh lũy tiến song hành đặc trưng nhưng không sử dụng [conJUNCtion][LIÊN] phụ thuộc truyền thống.</li>
			...
			<p className="text-indent-whole"><strong>Làm khối</strong> [<strong>SUBject PROnoun</strong>][<strong>CHỦ ĐẠI</strong>]:</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">Khối bao ngoài [to underSTAND {'{why the SPEcies went exTINCT}'}] là một [TIERed PARTicle BARE VERB PHRASE][TẦNG HẠT THUẦN ĐỘNG CỤM] bắt đầu bằng [PARTicle BARE VERB][HẠT THUẦN ĐỘNG] "to underSTAND".</li>
					...
					<li className="list-none">Khối {'{why the SPEcies went exTINCT}'} bên trong đóng vai trò là [NOUN CLAUSE][DANH CÂU] làm [OBject PROnoun][TÂN ĐẠI] chịu sự điều phối của [BARE VERB][THUẦN ĐỘNG] "underSTAND".</li>
			...
			<p className="margin-top-20 text-indent-whole"><strong>Làm khối</strong> [<strong>OBject PROnoun</strong>][<strong>TÂN ĐẠI</strong>]:</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">Khối bao ngoài [to DEMonstrate {'{HOW the DRUG WORKS}'}] là một [TIERed PARTicle BARE VERB PHRASE][TẦNG HẠT THUẦN ĐỘNG CỤM] bắt đầu bằng [PARTicle BARE VERB][HẠT THUẦN ĐỘNG] "to DEMonstrate".</li>
					...
					<li className="list-none">Khối {'{HOW the DRUG WORKS}'} bên trong đóng vai trò là [NOUN CLAUSE][DANH CÂU] làm [OBject PROnoun][TÂN ĐẠI] chịu sự điều phối trực tiếp của [BARE VERB][THUẦN ĐỘNG] "DEMonstrate".</li>

					<li className="list-none">Toàn bộ khối hỗn hợp [to DEMonstrate {'{HOW the DRUG WORKS}'}] vận hành với chức năng [<strong>NOUN PHRASE</strong>][<strong>DANH CỤM</strong>] đóng vai trò tổng thể làm khối [OBject PROnoun][TÂN ĐẠI] chịu sự điều phối trực tiếp của [BARE VERB][THUẦN ĐỘNG] HOPE.</li>
			...
			<h4 className="margin-y-40">3. [TRẠNG CỤM][ADverb PHRASE]</h4>
				...
				<ul className="list-square">
					...
					<li className="margin-bottom-20 list-none">Bên trong bao gói {'{HOW FREquently the SERver CRASHED}'} là một [conJUNCtional CLAUSE][LIÊN CÂU] bắt đầu bằng tổ hợp tuyến tính gồm [conJUNCtion][LIÊN] "HOW" kết hợp cùng [ADVERB][TRẠNG] "FREquently".</li>
			
					<li className="list-none">Chức năng:</li>

					<li className="list-none">Khối {'{HOW FREquently the SERver CRASHED}'} bên trong thực thi chức năng [NOUN CLAUSE][DANH CÂU] làm [OBject PROnoun][TÂN ĐẠI] nhận quan hệ trực tiếp đứng sau [COMplex prepoSITion][PHỨC GIỚI] be<strong>cause</strong> of.</li>

					<li className="list-none">Toàn bộ khối hỗn hợp [be<strong>cause</strong> of {'{HOW FREquently the SERver CRASHED}'}] thực thi chức năng [<strong>ADverb PHRASE</strong>][<strong>TRẠNG CỤM</strong>] tổng thể đứng cuối để bổ nghĩa hoàn cảnh nguyên nhân cho [PAST TENSE VERB][QUÁ THỜI ĐỘNG] rediSIGNED.</li>
			...
			<p className="margin-top-20 text-indent-whole"><strong>Dùng hình thái</strong> [<strong>conJUNCtional CLAUSE</strong>][<strong>LIÊN CÂU</strong>]</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">Hình thái: Khối [be<strong>cause</strong> the inTERnal TEMPERature EScalated RAPidly] - [conJUNCtional CLAUSE][LIÊN CÂU] bắt đầu bằng [conJUNCtion][LIÊN] "be<strong>cause</strong>" kết hợp với cấu trúc khối hoàn chỉnh có [SUBject PROnoun][CHỦ ĐẠI] "the inTERnal TEMPERature" và [PAST TENSE VERB][QUÁ THỜI ĐỘNG] "EScalated".</li>
			...
			<p className="margin-top-20 text-indent-whole"><strong>Đổi sang hình thái</strong> [<strong>MODified ADVERB</strong>][<strong>DIỆN TRẠNG</strong>]</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">Hình thái: Khối [acCORDingly] - [MODified ADVERB][DIỆN TRẠNG] hình thành từ khối [ROOT VERB][RỄ ĐỘNG] nguyên bản "acCORD" mặc thêm (kết hợp) hậu tố "-ing" và "-ly" để thay đổi diện mạo bên ngoài thành một khối cấp độ [BASE][CƠ] bối cảnh độc lập.</li>
			
					<li className="list-none">Chức năng: Khối [acCORDingly] - [ADVERB][TRẠNG] đứng biệt lập ở đầu câu để bổ nghĩa liên kết logic hệ quả cho toàn bộ nhận định phía sau.</li>
			...
			<p className="margin-top-20 text-indent-whole"><strong>Đổi sang hình thái</strong> [<strong>MODified ADjective</strong>][<strong>DIỆN TÍNH</strong>]</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">Hình thái: Khối [RENdering-acCELerating] - [MODified ADjective][DIỆN TÍNH] hình thành từ khối [ROOT VERB][RỄ ĐỘNG] nguyên bản "acCELerate" mặc thêm (kết hợp) tiền tố thành phần [PRESent PARTiciple VERB][HIỆN TIẾP ĐỘNG] "RENdering-" và hậu tố "-ING" để thay đổi diện mạo bên ngoài thành một khối cấp độ [BASE][CƠ] có cấu hình ghép.</li>
			
					<li className="list-none">Chức năng: Khối [RENdering-acCELerating] - [ADjective][TÍNH] đứng trực tiếp phía trước để bổ nghĩa đặc tính vận hành cho khối biểu thị thực thể "CODE".</li>
			...
			<p>Hãy áp dụng ngay phương pháp [<strong>Thế thân</strong>][<strong>Substitution</strong>] dựa trên nguyên lý thay thế bằng một khối từ mức độ [BASE][CƠ] cơ bản:</p>
				...
				<ul className="list-square">
					...
					<li className="margin-bottom-20 list-none">Nếu thế thế thân bằng một [ADVERB][TRẠNG] đơn lẻ (THEN, THERE) thành công</li>
					<li className="list-none">→ Khối đó đảm nhiệm chức năng [<strong>ADverb CLAUSE</strong>][<strong>TRẠNG CÂU</strong>].</li>
			
					<li className="margin-bottom-20 list-none">Nếu thế thế thân bằng một [ADjective][TÍNH] đơn lẻ (BEAUtiful, SMART, NEW) thành công</li>
					<li className="list-none">→ Khối đó phụ trách chức năng [<strong>ADjective CLAUSE</strong>][<strong>TÍNH CÂU</strong>].</li>
			
					<li className="margin-bottom-20 list-none">Nếu thế thế thân bằng một ký hiệu tổng quát "SOMEthing" hoặc "it" (tương đương một [NOUN][DANH]) thành công</li>
			...
			<p className="margin-top-20">Trường hợp A: Thử thế thân bằng [ADVERB][TRẠNG] "<strong>[THERE]</strong>"</p>
			...
			<p className="margin-top-20">Trường hợp B: Thử thế thân bằng [ADjective][TÍNH] "<strong>[NEW]</strong>"</p>
			...
			<p className="margin-top-20">Trường hợp C: Thử thế thân bằng [NOUN][DANH] "<strong>[SOMEthing]</strong>"</p>
