...
export default function ThreeDC6(): React.ReactElement {

	const postId = "ThreeDC6";
	...
	<main className="image image2">
		...
		<article>
			...
			<h4 className="margin-y-40">Câu con ADjective / quan hệ (Adjective / Relative clause)</h4>
			...
			<h4 className="margin-y-40">Trạng ngữ</h4>
