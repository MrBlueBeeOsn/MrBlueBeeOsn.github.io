...
export default function ThreeDC5(): React.ReactElement {

	const postId = "ThreeDC5";
	...
	<main className="image image2">
		...
		<article>
			...
			<h4 className="margin-y-40">ĐẠI quan hệ (Relative Pronouns)</h4>
			...
			<h4 className="margin-y-40">Khi nào bỏ PROnoun quan hệ?</h4>
			...
			<div className="viewcounter">
				...
				<div className="post-date no-margin">
					<span>JUNE 03, 2026 · by Claud and 🐝Mr. Bee Osn ·</span>
				</div>
