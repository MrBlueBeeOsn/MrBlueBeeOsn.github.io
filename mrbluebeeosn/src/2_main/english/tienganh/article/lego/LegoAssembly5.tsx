...
export default function LegoAssembly5(): React.JSX.Element {
	...
	<main className="image image2">
		...
		<article>
			...
			<p>Học tiếng Anh theo kiểu truyền thống, bạn phải nhớ "⏳ Thời Gian Hành Động ở Hiện Tại Đơn", "⏱️ Thời Điểm Hành Động ở Quá Khứ Tiếp Diễn", rồi hàng chục bảng chia hành động với đầy ngoại lệ.</p>
			...
			<p>Head không chỉ là ĐỘNG. Nó là trung tâm điều khiển của câu — gánh luôn chỉ dấu thời gian, ngôi số, và cả phủ định khi cần.</p>
			...
			<p>DP là tất cả những gì đứng sau Head, không có hành động chia riêng bên trong. Nó có thể là TÍNH, DANH, cụm V-ing, cụm nguyên mẫu, TRẠNG, hoặc cụm GIỚI.</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">She - S</li>
					<li className="list-none">is - Head</li>
					<li className="margin-bottom-20 list-none">happy today - DP TÍNH</li>
					...
					<li className="list-none">He - S</li>
					<li className="list-none">buys - Head</li>
					<li className="margin-bottom-20 list-none">a new car - DP DANH</li>
					...
					<li className="margin-bottom-20 list-none">in Vietnam - DP GIỚI</li>
			...
			<h4 className="margin-y-40">DC bổ nghĩa NOUN trong S — Relative Clause</h4>
					
			<p className="text-indent-whole">DC có thể nằm bên trong S để bổ nghĩa cho DANH. Khi đó cấu trúc là: S [DC] Head DP.</p>
