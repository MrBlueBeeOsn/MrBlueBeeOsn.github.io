...
export default function LegoAssembly4(): React.JSX.Element {
	...
	<main className="image image2">
		...
		<article>
			...
			<h3 className="margin-y-50 text-center">5. Head Có Thể Tích Hợp Bên Trong ĐỘNG</h3>
			...
			<h3 className="margin-y-50 text-center">7. Vì Sao [ĐỘNG] Sau Head Luôn Ở Nguyên Mẫu?</h3>
