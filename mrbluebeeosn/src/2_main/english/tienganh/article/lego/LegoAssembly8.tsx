	...
	<main className="image image2">
		...
		<article>
			...
			<ul className="list-square">
				...
				<li><strong>Tách rời</strong>: thời gian hành động đứng riêng.</li>
			...
			<h3 className="margin-y-50 text-center">2. Ví dụ nền tảng</h3>
				...
				<ul className="list-square">
					...
					<li className="margin-bottom-20 list-none">tired - DP - vì tired đứng sau Head, nó là DP, dù truyền thống gọi là ADjective vị ngữ.[tired]</li>
			...
			<p className="margin-top-20 text-indent-whole">"standing over there" giờ trông như DP thường, nhưng việc làm vẫn là của DC. Gọi đây là DP ADjective cho dễ nhớ.</p>
