          ...
          <li>must secure → [Áp-Thái Động Cơ] must (ép buộc) + [Thuần Động Cơ] secure</li>
			...
			<h4 className="margin-y-40">B. [Danh Cụm][Noun Phrase] làm [Danh Nhận][Noun Object]</h4>
				...
				<ul className="list-square">
					...
					<li className="margin-bottom-20 list-none">Hình thái: Khối tổng thể [to beautify {'{what the legacy script outputs}'}] - [Hạt Thuần Tầng Động Cụm][Particle Tiered Bare Verb Phrase] ở tầng ngoài. Bên trong chứa bao gói {'{what the legacy script outputs}'} - [Hiển-Liên Động Câu][Connector Verb Clause] ở tầng trong.</li>
