          ...
          <li>must seCURE → [asSERTive MOdal VERB] must (ép buộc) + [BARE inFINitive VERB][THUẦN NGUYÊN ĐỘNG] to seCURE</li>
			...
			<p className="margin-top-20 text-indent-whole" id="SUBject-HEAD"><strong>Hình thành Chức năng</strong> [<strong>SUBject HEAD</strong>][<strong>CHỦ LÕI</strong>] <strong>làm</strong> [<strong>SUBject</strong>][<strong>CHỦ</strong>]:</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">Chức năng: [conFIGuring] – [SUBject HEAD][CHỦ LÕI] đóng vai trò làm [SUBject][CHỦ] chịu trách nhiệm thực thi câu lớn.</li>
			...
			<p className="margin-top-20 text-indent-whole" id="OBject-HEAD"><strong>Hình thành Chức năng</strong> [<strong>OBject HEAD</strong>][<strong>TÂN LÕI</strong>] <strong>làm</strong> [<strong>OBject</strong>][<strong>TÂN</strong>]:</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">Chức năng: [deBUGging] – [OBject HEAD][TÂN LÕI] đóng vai trò làm [OBject][TÂN] đứng sau làm mục tiêu chịu tác động trực tiếp từ [VERB HEAD][ĐỘNG LÕI] "supPORTS".</li>
			...
			<p className="margin-top-20 text-indent-whole" id="NOUN-PHRASE"><strong>Hình thành Chức năng</strong> [<strong>NOUN PHRASE</strong>][<strong>DANH CỤM</strong>] <strong>làm</strong> [<strong>SUBject PROnoun</strong>][<strong>CHỦ ĐẠI</strong>]:</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">Chức năng: [to enCRYPT the SYStem communiCAtion] – [NOUN PHRASE][DANH CỤM] đóng vai trò làm [SUBject PROnoun][CHỦ ĐẠI] đứng sau [THIRD-PERson SINGular VERB PHRASE ][NGÔI 3 S ĐỘNG CỤM] "TAKES a LOT of TIME" để bổ nghĩa cho [DUMmy PROnoun][GIẢ ĐẠI] "it" chịu trách nhiệm thực thi câu lớn.</li>
			...
			<p className="margin-top-20 text-indent-whole" id="ADjective-PHRASE"><strong>Hình thành Chức năng</strong> [<strong>ADjective PHRASE</strong>][<strong>TÍNH CỤM</strong>]:</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">Chức năng: [HANdling USer TRAFfic efFIciently] – [ADjective PHRASE][TÍNH CỤM] đứng sau kết hợp với [FInite VERB][HẠN ĐỘNG] "is" nhằm mô tả trạng thái thuộc tính diễn tiến cho [SUBject HEAD][CHỦ LÕI] "the MIcroservice" dịch vụ nhỏ.</li>
			...
			<p className="margin-top-20 text-indent-whole"><strong>Hình thành Chức năng</strong> [<strong>ADjective PHRASE</strong>][<strong>TÍNH CỤM</strong>]:</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">Chức năng: [for the WEB FRAMEwork] – [ADjective PHRASE][TÍNH CỤM] đứng ngay sau đối tượng [SUBject HEAD][CHỦ LÕI] "the documenTAtion" nhằm xác định rõ thuộc tính định danh cho tài liệu.</li>
			...
			<h4 className="margin-y-40">B. [NOUN PHRASE][DANH CỤM] làm [OBject PROnoun][TÂN ĐẠI]</h4>
				...
				<ul className="list-square">
					...
					<li className="list-none">Khối {'{WHAT the LEgacy SCRIPT OUTputs}'} bên trong đóng vai trò làm [NOUN CLAUSE][DANH CÂU] làm [OBject PROnoun][TÂN ĐẠI] chịu sự điều phối hành động trực tiếp từ [FULL inFINitive VERB][TOÀN NGUYÊN ĐỘNG] "to BEAUtify".</li>
