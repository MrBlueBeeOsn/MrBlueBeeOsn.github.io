...
export default function SuperWords3(): React.JSX.Element {
	...
	<main className="image image2">
		...
		<article>
			...
			<h4 className="margin-bottom-30 text-center">Siêu DANH, Siêu TÍNH, Siêu [TRẠNG] – Cách Gọi Mới Giúp Học Câu Con Tiếng Anh Dễ Hơn</h4>
			...
			<h4 className="margin-y-40">1. Siêu [DANH] (Super Noun / Noun Clause)</h4>
					
			<p className="text-indent-whole"></p>


			<h4 className="margin-y-40">2. Siêu [TÍNH] (Super Adjective / Adjective Clause / Relative Clause)</h4>
					
			<p className="text-indent-whole"></p>


			<h4 className="margin-y-40">3. Siêu [TRẠNG] (Super Adverb / Adverb Clause)</h4>
			...
			<h3 className="margin-y-50 text-center">3. Lợi ích của cách gọi Siêu [DANH] – Siêu [TÍNH] – Siêu TRẠNG</h3>
