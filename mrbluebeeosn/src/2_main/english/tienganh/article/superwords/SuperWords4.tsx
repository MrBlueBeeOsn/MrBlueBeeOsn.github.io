...
export default function SuperWords4(): React.JSX.Element {
	...
	<main className="image image2">
		...
		<article>
			...
			<h4 className="margin-bottom-30 text-center">Siêu DANH, Siêu [TÍNH] Và Siêu TRẠNG: Một Cách Nhìn Mới Về Câu Con Tiếng Anh</h4>
			...
			<h3 className="margin-y-50 text-center">3. Siêu [DANH] (Noun Clause)</h3>
			...
			<h3 className="margin-y-50 text-center">4. Siêu [TÍNH] (Adjective Clause)</h3>
			...
			<h3 className="margin-y-50 text-center">5. Siêu [TRẠNG] (Adverb Clause)</h3>
