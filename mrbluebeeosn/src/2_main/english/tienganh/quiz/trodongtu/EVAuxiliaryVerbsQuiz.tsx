...
export default function EVAuxiliaryVerbsQuiz(): React.JSX.Element {
	...
	const questions: Question[] = [
		...
		},
		{
			...
			correctAnswer: 2,
			explanation: "Để đặt câu hỏi cho hành động đã kết thúc trong quá khứ (yesterday), ta dùng trợ động từ \"Did\" của thì quá khứ đơn."
		},
		{
			id: 3,
			...
			correctAnswer: 0,
			explanation: "Cụm từ \"at the moment\" dấu hiệu của thì hiện tại tiếp diễn, công thức là \"be + V-ing\". Với chủ ngữ \"She\", trợ động từ phù hợp là \"is\"."
		},
		{
			id: 4,
			...
			correctAnswer: 2,
			explanation: "\"Should\" là trợ động từ khuyết thiếu dùng để đưa ra lời khuyên. Ngữ cảnh trời tối sầm nên khuyên mang theo ô là hợp lý nhất."
		},
		{
			id: 5,
		...
		},
		{
			...
			correctAnswer: 1,
			explanation: "Câu diễn tả một thói quen hoặc trạng thái trong quá khứ (\"when he was a child\") nên dùng trợ động từ phủ định của quá khứ đơn là \"didn't\"."
		},
		{
			id: 7,
		...
		},
		{
			...
			correctAnswer: 3,
			explanation: "\"Can\" được dùng làm trợ động từ để đưa ra một lời đề nghị giúp đỡ hoặc hỏi về khả năng."
		},
		{
			id: 9,
		...
		},
		{
			...
			correctAnswer: 0,
			explanation: "Đây là câu điều kiện loại 1, mệnh đề chính dùng trợ động từ \"will\" để diễn tả một kết quả có thể xảy ra ở tương lai."
		}
	];
		...
		<main className="image image2">
			...
			<article>
				...
				<header className="quiz-header">
					<h1 className="margin-y-50 text-center">Trắc Nghiệm Auxiliary Verbs</h1>
