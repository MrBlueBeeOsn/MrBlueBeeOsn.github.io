...
export default function EVMatrixQuiz(): React.JSX.Element {
	...
	const questions: Question[] = [
		...
		},
		{
			...
			correctAnswer: 1,
			explanation: "Hình thái: [that you lent me yesterday] - [Liên Câu][Conjunctional Base] bắt đầu bằng một thành phần kết nối đi kèm đầy đủ một chủ thể (you) và hành vi đã chia thời gian (lent). \n\n Chức năng: [that you lent me yesterday] - [Tính Câu][Adjective Clause] đứng sau để bổ nghĩa và hạn định đặc điểm cho nhóm thành phần chỉ vật \"The book\"."
		},
		{
			id: 5,
			...
			correctAnswer: 1,
			explanation: "Hình thái: [know {what we should do next}] - [Tầng Thuần Động Cụm][Bare Tiered Verb Phrase] chứa hành vi hạt nhân \"know\" đi kèm thành phần bổ khuyết là một [Liên Câu][Conjunctional Base] có cấu trúc chủ-hành vi hoàn chỉnh ở tầng trong {}. \n\n Chức năng: [know {what we should do next}] - [Danh Cụm] Phân Tầng [Tiered Noun Phrase] đóng vai trò cụm tiếp nhận lớn bên ngoài, chứa một danh câu làm thành phần tiếp nhận trực tiếp cho \"know\" ở bên trong."
		},
		{
			id: 6,
			...
			correctAnswer: 1,
			explanation: "Hình thái: [as soon as the rain stops] - [Liên Câu][Conjunctional Base] bắt đầu bằng thành phần kết nối đi kèm kết cấu chủ-hành vi hoàn chỉnh (the rain stops) đã chia thời gian. \n\n Chức năng: [as soon as the rain stops] - [Trạng Câu][Adverb Clause] liên kết vào cấu trúc để xác định mốc thời gian diễn ra cho toàn bộ phần thông tin chính \"They will leave\"."
		},
		{
			id: 7,
