...
export default function EVPrimaryAuxiliaryVerbsQuiz(): React.JSX.Element {
	...
	const questions: Question[] = [
		...
		},
		{
			...
			correctAnswer: 2,
			explanation: "Câu nghi vấn ở thì Quá khứ đơn (Past Simple) mượn trợ động từ \"Did\" đứng trước chủ ngữ, động từ chính \"study\" giữ nguyên mẫu."
		},
		{
			id: 3,
			...
			correctAnswer: 0,
			explanation: "Câu ở thì Hiện tại tiếp diễn thể bị động (Present Continuous Passive): S + am/is/are + being + V3/ed. \"Statements\" là danh từ số nhiều nên dùng \"are\"."
		},
		{
			id: 4,
			...
			correctAnswer: 2,
			explanation: "Câu hỏi ở thì Hiện tại đơn với động từ thường \"insist\". Chủ ngữ \"he\" yêu cầu trợ động từ \"does\"."
		},
		{
			id: 5,
		...
		},
		{
			...
			correctAnswer: 1,
			explanation: "Dấu hiệu \"last year\" cho thấy đây là thì Quá khứ đơn. Mượn trợ động từ \"Did\" cho câu hỏi với động từ thường \"provide\"."
		},
		{
			id: 7,
		...
		},
		{
			...
			correctAnswer: 2,
			explanation: "Câu phủ định thì Hiện tại đơn với chủ ngữ \"They\" (số nhiều) sử dụng trợ động từ \"do\" + not."
		},
		{
			id: 9,
