...
export default function SVOMPT6(): React.JSX.Element {

	const postId = "SVOMPT6";
		...
		<article>
			...
			<h3 className="margin-y-50 text-center">1. Thành phần và vai trò</h3>
				...
				<ul className="list-square">
					...
					<li className="list-none"><strong>Verb</strong> là hành động chính, biểu thị hành động hoặc trạng thái.</li>

					<li className="margin-bottom-20 list-none"><strong>Subject</strong> là người hoặc vật thực hiện hành động.</li>
			
				</ul>

			<p className="margin-top-20">Quy tắc thực tế: khi có nhiều trạng ngữ, thứ tự sau hành động thường là <strong>Manner</strong> → <strong>Place</strong> → <strong>Time</strong>.</p>
			...
			<h3 className="margin-y-50 text-center">5. Bài tập luyện 10 phút mỗi ngày</h3>
				...
				<ol>
					...
					<li>Viết 5 câu theo SVOMPT với 5 hành động khác nhau.</li>
