...
export default function SVOMPT2(): React.JSX.Element {

	const postId = "SVOMPT2";
		...
		<article>
			...
			<p>Hãy chia đường thẳng ấy thành sáu bậc, từ dưới lên trên:</p>
				...
				<ul className="list-square">
					...
					<li><strong>Bậc 2</strong> – <strong>V</strong> (<strong>Verb</strong> – <strong>ĐỘNG</strong>)</li>
			...
			<p>Điều kỳ diệu là: đường thẳng đứng này cũng chính là đường thẳng <strong>từ gần đến xa</strong>. Khi bắt đầu câu, bạn đang ở rất gần – gần với bản thân (danh chủ), gần với hành động (VERB). Càng về cuối, bạn càng đi xa – xa vào không gian (địa điểm), xa vào thời gian (khi nào).</p>
			...
			<p className="margin-top-20">TRẠNG tần suất (always, never, often) thường chen giữa S và V – một bậc phụ rất nhỏ, nhưng vẫn nằm trên đường thẳng. Hãy coi đó là những bậc lửng – không làm gãy trật tự tổng thể.</p>
