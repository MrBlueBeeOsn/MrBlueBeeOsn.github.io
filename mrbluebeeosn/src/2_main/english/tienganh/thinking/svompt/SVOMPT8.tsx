		...
		<article>
			...
			<p>Hãy nhìn lên từ chân bạn. Càng lên cao, chi tiết càng lùi xa:</p>
				...
				<ul className="list-square">
					...
					<li className="margin-bottom-20 list-none">Nhúng cao nhất, mờ nhất. Khi nào câu xảy ra. after work, this morning, every Sunday.</li>
					...
					<li className="margin-bottom-20 list-none">Cách hành động diễn ra. slowly, quietly, with care. Nó luôn bám sát ĐỘNG.</li>
