		...
		<article>
			...
			<p className="text-indent-whole">Đóng vai trò như <strong>DANH</strong> — làm danh chủ, danh nhận, hoặc bổ ngữ.</p>
				...
				<ul className="list-square">
					...
					<li><strong>What she said</strong> is true. (danh chủ)</li>
					<li className="margin-bottom-20 list-none"><strong>Những gì cô ấy nói</strong> là đúng đấy.</li>
			
					<li>I don't know <strong>what she wants</strong>. (danh nhận)</li>
			...
			<p className="margin-top-20">Câu cuối có <strong>ba câu con</strong>, hai phụ câu (because... và although...) và một câu con ADjective (which...). Đây là mức độ <strong>người bản xứ</strong>.</p>
