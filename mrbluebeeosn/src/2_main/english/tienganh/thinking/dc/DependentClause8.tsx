...
export default function DependentClause8(): React.JSX.Element {
	...
	<main className="image image2">
		...
		<article>
			...
			<p className="margin-top-20 text-indent-whole"><strong>when</strong> = <strong>on which</strong>. Sau NOUN chỉ thời gian, when tự nhiên hơn that. Nếu bạn viết "the day that everything changed" vẫn đúng, nhưng when tạo cảm giác kể chuyện.</p>
			...
			<p>3. Hỏi:</p>
				...
				<ul className="list-square">
					...
					<li>Bỏ đi thì NOUN có còn rõ không?</li>
