...
export default function DependentClause2(): React.JSX.Element {
	...
	<main className="image image2">
		...
		<article>
			...
			<h4 className="margin-bottom-30 text-center">Làm chủ phụ câu: Công thức viết câu tiếng Anh giàu bản sắc</h4>

			<p>Bạn đã bao giờ tự hỏi:</p>

			<p>Tại sao có người viết tiếng Anh chỉ vài câu mà thấy “sâu”, còn mình viết cả đoạn vẫn thấy “nông”?</p>

			<p>Vấn đề không nằm ở số lượng từ. Nó nằm ở cách sắp xếp ý. Và chìa khóa của cách sắp xếp ấy chính là <strong>phụ câu</strong> (<strong>Dependent Clause</strong>).</p>
			...
			<p>Bạn cần phân biệt nó với câu con độc lập.</p>

			<p>Một câu con độc lập có thể đứng riêng thành một câu hoàn chỉnh.</p>

			<p>Một phụ câu thì không – nhưng điều đó không có nghĩa là nó “sai”. Nó chỉ cần một câu con khác đi kèm.</p>
			...
			<p>Bạn đọc câu sau, gạch chân phần nào bắt đầu bằng các từ trên:</p>
				...
				<ul className="list-square">
					...
					<li className="margin-bottom-20 list-none">→ <strong>until you come back</strong> là phụ câu.</li>
					...
					<li className="margin-bottom-20 list-none">→ <strong>where I grew up</strong> là phụ câu.</li>

					<li>As she opened the door, the phone rang.</li>
					<li className="margin-bottom-20 list-none">Khi cô ấy mở cửa, điện thoại reo.</li>

					<li className="list-none">→ <strong>As she opened the door</strong> là phụ câu.</li>
			
				</ul>


			{/* Ba bước để viết một câu có phụ câu */}

			<h3 className="margin-y-50 text-center">Ba bước để viết một câu có phụ câu</h3>
			...
			<p className="text-indent-whole">Bạn cần ít nhất hai câu con. Một sẽ là chính, một là phụ. Hãy bắt đầu từ hai câu đơn giản.</p>
			...
			<h4 className="margin-y-40">Bước 3: Đặt câu con phụ ở vị trí hợp lý và thêm dấu phẩy nếu cần</h4>

			<p className="text-indent-whole">Có hai cách:</p>

			<p className="text-indent-whole"><strong>Cách 1</strong> – <strong>Câu con phụ đứng đầu</strong>:</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">→ Dấu phẩy sau câu con phụ.</li>
			
				</ul>
			
			
			<p className="margin-top-20 text-indent-whole"><strong>Cách 2</strong> – <strong>Câu con phụ đứng cuối</strong>:</p>
			...
			<p className="margin-top-20 text-indent-whole">Lưu ý: Khi although ở giữa câu, không có dấu phẩy. Điều này khác với because? Không, quy tắc dấu phẩy hoàn toàn giống: chỉ dùng dấu phẩy khi câu con phụ đứng đầu.</p>

			{/* Làm thế nào để phân biệt phụ câu với câu con chính mà không nhầm? */}

			<h3 className="margin-y-50 text-center">Làm thế nào để phân biệt phụ câu với câu con chính mà không nhầm?</h3>
			
			<h4 className="margin-y-40">Bài kiểm tra 1: Câu hỏi “Vậy thì sao?”</h4>

			<p className="text-indent-whole">Đọc cụm từ đó và hỏi “Vậy thì sao?”. Nếu bạn thấy thiếu một phần trả lời cho câu hỏi đó, nó là phụ câu.</p>
			...
			<p className="text-indent-whole">Hãy thử thay nó bằng một từ như something hay that thing. Nếu thay được, rất có thể nó là câu con NOUN – một loại phụ câu.</p>
			...
			<p className="margin-top-20 text-indent-whole">→ Đó là phụ câu.</p>

			{/* Lộ trình làm chủ phụ câu trong 2 tuần */}

			<h3 className="margin-y-50 text-center">Lộ trình làm chủ phụ câu trong 2 tuần</h3>
			...
			<h4 className="margin-y-40">Tuần 1 – Nhận diện và phân tích</h4>
				...
				<ul className="list-square">
					...
					<li>Ngày 1-2:</li>
					<li className="margin-bottom-20 list-none">Đọc một bài báo ngắn (ví dụ BBC, VOA). Dùng bút chì gạch chân tất cả các từ nối (who, which, that, because, although, when, while, as, if, unless, where, etc.). Mỗi khi thấy một từ đó, hãy xác định xem nó có bắt đầu một câu con có danh chủ – hành động hay không.</li>
			...
			<h4 className="margin-y-40">Tuần 2 – Sản sinh chủ động</h4>
				...
				<ul className="list-square">
					...
					<li>Ngày 8-9:</li>
					<li className="margin-bottom-20 list-none">Lấy một đoạn văn toàn câu đơn do chính bạn viết. Khoanh tròn các cặp câu có liên quan về ý. Viết lại chúng thành câu phức với phụ câu.</li>
			
					<li>Ngày 10-11:</li>
					<li className="margin-bottom-20 list-none">Tập chuyển đổi vị trí câu con phụ (đầu câu, cuối câu, chen giữa). Quan sát sự thay đổi về nhịp điệu và sự nhấn mạnh.</li>
			
					<li>Ngày 12-14:</li>
					<li className="list-none">Viết một đoạn văn ngắn (5-7 câu) chủ đề tự do, trong đó mỗi câu đều có ít nhất một phụ câu. Sau đó đọc to lên. Nếu nghe tự nhiên, bạn đã thành công.</li>
			...
			<p>Viết tiếp:</p>
				...
				<ul className="list-square">
					...
					<li className="list-none">Chú ý: <strong>so</strong> là <strong>FANBOYS</strong>, không phải từ nối câu con phụ.</li>
			
				</ul>
			
			<p className="margin-top-20">Để dùng câu con phụ, hãy dùng <strong>because</strong>:</p>
			...
			<p>Sai thì sửa. Người bản xứ cũng sai. Chỉ có điều họ sửa nhanh vì họ hiểu bản chất: phụ câu tồn tại là để làm cho câu chính trở nên rõ ràng và phong phú hơn.</p>
