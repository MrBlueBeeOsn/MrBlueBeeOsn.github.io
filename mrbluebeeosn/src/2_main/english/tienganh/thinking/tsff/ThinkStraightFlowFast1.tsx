...
export default function ThinkStraightFlowFast1(): React.JSX.Element {
	...
	<main className="image image2">
		...
		<article>
			...
			<p>Khi quan sát những người học đến từ Đức, Hà Lan, hay thậm chí là Nhật Bản và Trung Quốc, chúng ta thấy họ bắt nhịp với cấu trúc tiếng Anh rất nhanh. Lý do là vì trong ngôn ngữ mẹ đẻ của họ, <strong>TÍNH luôn đứng trước DANH</strong>.</p>
