...
export default function ThinkStraightFlowFast4(): React.JSX.Element {
	...
	<main className="image image2">
		...
		<article>
			...
			<p className="margin-top-20 quote"><strong>Chuyển cấu trúc tiếng Việt sang cùng trật tự với tiếng Anh. ADjective đứng trước danh cơ</strong></p>
			...
			<p className="margin-top-20">Trong ngôn ngữ của họ:</p>
				...
				<ul>
					...
					<li>tính cơ đứng trước NOUN là chuyện bình thường</li>
