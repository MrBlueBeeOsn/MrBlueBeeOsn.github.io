	...
	const questions: Question[] = [
		{
			...
			correctAnswer: 0,
			explanation: "Morphology: [Recording transactions] - [Động Cụm][Verb Phrase] consisting of the gerund \"recording\" and its direct object \"transactions\" working together as a structural unit. \n\n Function: [Recording transactions] - [Danh Cụm][Noun Phrase] serving as the complete subject of the sentence to initiate the main verb \"is\"."
		},
		{
			id: 2,
			...
			correctAnswer: 1,
			explanation: "Morphology: [to maintain accurate ledgers] - [Động Cụm][Verb Phrase] formed by an infinitive verb followed by its modifying financial adjective and noun object. \n\n Function: [to maintain accurate ledgers] - [Danh Cụm][Noun Phrase] acting as a subject complement to explain what the primary goal is after the linking verb."
		},
		{
			id: 3,
			...
			correctAnswer: 0,
			explanation: "Morphology: [audited] - [Động Cơ][Verb Base] using a single past participle form of the verb to function as a modifier. \n\n Function: [audited] - [Tính Cơ][Adjective Base] directly modifying the financial noun \"statements\" to clarify their verified status."
		},
		{
			id: 4,
			...
			correctAnswer: 0,
			explanation: "Morphology: [while reconciling the bank statement] - [Động Cụm][Verb Phrase] structured as a reduced adverbial phrase containing a time conjunction and a gerund phrase. \n\n Function: [while reconciling the bank statement] - [Trạng Cụm][Adverb Phrase] modifying the main action \"found\" by establishing the exact accounting timeframe."
		},
		{
			id: 5,
			...
			correctAnswer: 1,
			explanation: "Morphology: [That the company's annual revenue increased] - [Động Câu][Verb Clause] containing a subordinate conjunction, a clear corporate subject, and an intransitive past tense verb. \n\n Function: [That the company's annual revenue increased] - [Danh Câu][Noun Clause] functioning as the complete grammatical subject that triggered the psychological reaction of the investors."
		},
		{
			id: 6,
		...
		},
		{
			...
			correctAnswer: 1,
			explanation: "Morphology: [Because the travel expenses were not authorized] - [Động Câu][Verb Clause] utilizing a causal conjunction coupled with a complete financial subject and a passive voice verb structure. \n\n Function: [Because the travel expenses were not authorized] - [Trạng Câu][Adverb Clause] modifying the independent clause by providing the regulatory reason why the reimbursement failed."
		},
		{
			id: 8,
			...
			correctAnswer: 0,
			explanation: "Morphology: [used for payroll processing] - [Động Cụm][Verb Phrase] appearing as a post-modifying past participial phrase linked with a prepositional structure. \n\n Function: [used for payroll processing] - [Tính Cụm][Adjective Phrase] defining and restricting the meaning of the specific technical noun \"software\" being discussed."
		},
		{
			id: 9,
			...
			correctAnswer: 1,
			explanation: "Morphology: [know {what she recorded}] - [Động Cụm][Verb Phrase] serving as the predicate of the matrix clause, which embeds a finite objective clause inside its boundaries. \n\n Function: [know {what she recorded}] - [Danh Cụm] Phân Tầng [Nested Noun Phrase] where the outer verbal predicate level marked by [] encapsulates an inner objective noun clause marked by {} representing the bookkeeping data."
		},
		{
			id: 10,
			...
			correctAnswer: 0,
			explanation: "Morphology: [whether the general ledger was updated] - [Động Câu][Verb Clause] introduced by an interrogative subordinator followed by a passive financial clause layout. \n\n Function: [whether the general ledger was updated] - [Danh Câu][Noun Clause] completing the predicate of the sentence by acting as the direct noun object for the inquiry verb \"asked\"."
		}
	];
