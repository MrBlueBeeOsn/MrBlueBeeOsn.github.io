...
export default function IELTSQuestions(): React.JSX.Element {
	// Danh sách câu hỏi về IELTS cơ bản
	...
	return (
		...
		<main className="image image2">
			...
			<article>
				...
				<h4><HashLink smooth to="/english#ielts-basic-practice"><mark className="highlight-tertiary-padding-4-8">IELTS</mark></HashLink></h4>
	
				<header className="quiz-header">
					<h1 className="margin-y-50 text-center">IELTS Multiple-Choice Questions</h1>
					<p className="subtitle text-center">Test your knowledge of fundamental IELTS concepts</p>
				</header>
