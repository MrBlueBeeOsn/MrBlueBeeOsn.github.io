...
export default function Exactly_2() {
  ...
  <main className="image image2">
    ...
    <h2 className="margin-y-50 text-center">exactly
      <sup>
        <Link to="/english/vocabulary/exactly-1">&nbsp;1&nbsp;</Link>
      </sup>
      <sup>
        <Link to="/english/vocabulary/exactly-2">&nbsp;2&nbsp;</Link>
      </sup>
    </h2>
      ...
      <div>
        ...
        <p className="margin-y-10">
          ...
          <span className="highlight-255-padding-3-6">
            ...
            <Link to="/english/tienganh/he-thong-7-dau-phu-phien-am-tieng-anh-1">ėxactly</Link>/
