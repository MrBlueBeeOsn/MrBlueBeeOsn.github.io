...
export default function Precisely_1() {
  ...
  <main className="image image2">
    ...
    <p className="text-indent-whole">Thường xuyên sử dụng từ này trong các bài viết hoặc cuộc trò chuyện.</p>
      ...
      <p className="margin-bottom-50 text-indent-whole">Sự khác biệt: Câu thứ hai <span className="highlight6">nhấn mạnh rằng việc đo</span> lường được thực hiện <span className="highlight6">một cách cẩn thận và chính xác</span> đến từng chi tiết.</p>
