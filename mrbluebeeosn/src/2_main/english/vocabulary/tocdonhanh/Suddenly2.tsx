    ...
    <article>
      ...
      <div className="example">
        ...
        <p className="example-sentence text-center">
          ...
          <span className="highlight-255-padding-0-4 text-border">
            <HashLink smooth to="#REalized-that">REalized that</HashLink>
          </span> &nbsp;
          ...
          <span className="highlight-255-padding-0-4 text-border">
            <HashLink smooth to="#REalized-that2">REalized that</HashLink>
          </span> &nbsp;
        ...
        <div>
          ...
          <p className="margin-y-10">
            ...
            <span className="highlight-255-padding-3-6">
              ...
              SUDdenly \<Link to="/pronunciation/5-vowel-system">SƯD de̛n ly</Link>\ /ˈsʌdənli/ ⬤•• (THREE SYLlables)
      ...
      <ol className="margin-top-30 padding-left-30">
        ...
        <li value="9" id="REalized-that2">i SUDdenly [REalized that] i had been WALking in CIRcles.</li>
