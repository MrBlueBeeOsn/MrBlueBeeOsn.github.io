  ...
  <main className="image image2">
    ...
    <article>
      ...
      <div className="example">
        ...
        <p className="example-sentence text-center">
          <span className="highlight-255-padding-0-4 text-border" >
            <HashLink smooth to="#STOPPED">STOPPED</HashLink>
          </span> &nbsp;
          ...
          <span className="highlight-255-padding-0-4 text-border">
            <HashLink smooth to="#apPEARED">apPEARED</HashLink>
          </span> &nbsp;
          ...
          <span className="highlight-255-padding-0-4 text-border">
            <HashLink smooth to="#FELT">FELT</HashLink>
          </span> &nbsp;
          ...
          <span className="highlight-255-padding-0-4 text-border">
            <HashLink smooth to="#REalized2">REalized</HashLink>
          </span> &nbsp;

          <span className="highlight-255-padding-0-4 text-border">
            <HashLink smooth to="#STOPPED2">STOPPED</HashLink>
          </span> &nbsp;
        ...
        <div>
          ...
          <p className="margin-y-10">
            ...
            <span className="highlight-255-padding-3-6">
              ...
              [SUDdenly][<Link to="/pronunciation/5-vowel-system">SƯD de̛n ly</Link>] /ˈsʌdənli/ ⬤•• (3x)
              
            </span>
              
            &nbsp;trong tiếng Anh thường được sử dụng để mô tả một sự kiện hoặc thay đổi xảy ra một cách bất ngờ, không báo trước.
      ...
      <ol className="margin-top-30 padding-left-30">
        ...
        <li value="1" id="STOPPED">the CAR SUDdenly [STOPPED] in the MIDdle of the ROAD.</li>
        <li className="list-none margin-bottom-20">Chiếc xe đột ngột dừng lại giữa đường.</li>

        <li value="2" id="REalized">i SUDdenly [REalized] that i had forGOTten my KEYS.</li>
        <li className="list-none margin-bottom-20">Tôi đột nhiên [nhận ra] rằng mình đã quên chìa khóa.</li>

        <li value="3" id="apPEARED">a GHOST SUDdenly [apPEARED] in the MIRror.</li>
        ...
        <li value="5" id="FELT">i SUDdenly [FELT] a SHARP PAIN in my STOMach.</li>
        ...
        <li value="7" id="disapPEARED">the maGIcian SUDdenly [disapPEARED] in a PUFF of SMOKE.</li>
        ...
        <li value="9" id="REalized2">i SUDdenly [REalized] that i had been WALking in CIRcles.</li>
        <li className="list-none margin-bottom-20">Tôi đột nhiên [nhận ra] rằng mình đã đi vòng tròn.</li>

        <li value="10" id="STOPPED2">the comPUter SUDdenly [STOPPED] WORking.</li>
        <li className="list-none margin-bottom-20">Máy tính đột nhiên [ngừng] hoạt động.</li>

      </ol>

      <p>** Các cụm từ trên đều nhấn mạnh tính bất ngờ, đột ngột của một sự kiện hoặc thay đổi. Chúng thường được sử dụng để tạo ra hiệu ứng kịch tính hoặc nhấn mạnh tính bất ngờ của một tình huống.</p>
