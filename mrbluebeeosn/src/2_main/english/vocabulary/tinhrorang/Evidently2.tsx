		...
		<article>
			...
			<div className="text-border1 padding-10 highlight-238-padding-4-8 bee-container">
				...
				<div>
					...
					<p className="margin-y-10">
						...
						&nbsp;là một ADverb dùng để nhấn mạnh rằng một điều gì đó rất rõ ràng, dễ thấy hoặc có thể được suy luận ra từ những bằng chứng có sẵn.
			...
			<div className="margin-y-30 text-border1 table-container">
				...
				<ul className="list-square">
					...
					<li>"<strong>EVidently</strong>" thường được đặt ở đầu câu hoặc trước một ADjective hoặc tính cụm để nhấn mạnh.</li>
