    ...
    <article>
      ...
      <div className="example">
        ...
        <p className="example-sentence text-center">
          ...
          <span className="highlight-255-padding-0-4 text-border">
            <HashLink smooth to="#SPENT">SPENT</HashLink>
          </span> &nbsp;
          ...
          <span className="highlight-255-padding-0-4 text-border">
            <HashLink smooth to="#comMUnicated">comMUnicated</HashLink>
          </span> &nbsp;
          ...
          <span className="highlight-255-padding-0-4 text-border">
            <HashLink smooth to="#LEARNED">LEARNED</HashLink>
          </span> &nbsp;
        ...
        <div>
          ...
          <p className="margin-y-10">
            ...
            <span className="highlight-255-padding-3-6">
              ...
              proDUCTively \<Link to="/pronunciation/5-vowel-system">prơ DƯC tive ly</Link>\ /prəˈdʌk.tɪv.li/ •⬤•• (4x)
      ...
      <ol className="margin-top-30 padding-left-30">
        ...
        <li value="8" id="LEARNED">he proDUCTively [LEARNED] the NEW SOFTware by PRACticing REGularly.</li>
        <li className="list-none margin-bottom-20">Anh ấy [đã học] phần mềm mới một cách hiệu quả bằng cách luyện tập thường xuyên.</li>

        <li value="9" id="PLANNED">hey proDUCTively [PLANNED] the eVENT to enSURE everything RAN SMOOTHly.</li>
        ...
        <li value="10" id="conTRIButed">each MEMber proDUCTively [conTRIButed] their SKILLS to the TEAM'S sucCESS.</li>
