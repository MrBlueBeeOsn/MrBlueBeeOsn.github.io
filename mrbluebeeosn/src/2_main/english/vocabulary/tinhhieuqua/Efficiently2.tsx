  ...
  <main className="image image2">
    ...
    <article>
      ...
      <div className="example">
        ...
        <p className="example-sentence text-center">
          <span className="highlight-255-padding-0-4 text-border" >
            <HashLink smooth to="#MANages">MANages</HashLink>
          </span> &nbsp;

          <span className="highlight-255-padding-0-4 text-border">
            <HashLink smooth to="#alLOWS">alLOWS</HashLink>
          </span> &nbsp;

          <span className="highlight-255-padding-0-4 text-border">
            <HashLink smooth to="#USE">USE</HashLink>
          </span> &nbsp;

          <span className="highlight-255-padding-0-4 text-border" >
            <HashLink smooth to="#comMUnicate-to">comMUnicate to</HashLink>
          </span> &nbsp;

          <span className="highlight-255-padding-0-4 text-border">
            <HashLink smooth to="#proDUCES">proDUCES</HashLink>
          </span> &nbsp;

          <span className="highlight-255-padding-0-4 text-border">
            <HashLink smooth to="#SOLVED-and-FOUND">SOLVED and FOUND</HashLink>
          </span> &nbsp;

          <span className="highlight-255-padding-0-4 text-border" >
            <HashLink smooth to="#LEARN-and-acQUIRE">LEARN and acQUIRE</HashLink>
          </span> &nbsp;

          <span className="highlight-255-padding-0-4 text-border">
            <HashLink smooth to="#ORganizes">ORganizes</HashLink>
          </span> &nbsp;
          ...
          <span className="highlight-255-padding-0-4 text-border">
            <HashLink smooth to="#Utilize">Utilize</HashLink>
          </span> &nbsp;
        ...
        <div>
          ...
          <p className="margin-y-10">
            ...
            <span className="highlight-255-padding-3-6">
              ...
              efFIciently \<Link to="/pronunciation/5-vowel-system">ef FIC ie̛nt ly</Link>\ /ɪˈfɪʃəntli/ •⬤•• (FOUR SYLlables)
      ...
      <ol className="margin-top-30 padding-left-30">
        ...
        <li value="1" id="MANages">she efFICiently [MANages] her TIME to comPLETE all her TASKS.</li>
        ...
        <li value="8" id="ORganizes">she efFICiently [ORganizes] her FILES and DOCuments.</li>
        <li className="list-none margin-bottom-20">Cô ấy [tổ chức] các tập tin và tài liệu của mình một cách hiệu quả.</li>

        <li value="9" id="transPORTS-to">the COMpany efFICiently [transPORTS] GOODS [to] CUStomers worldWIDE.</li>
        ...
        <li value="10" id="Utilize">we NEED to efFICiently [Utilize] our NATURal REsources.</li>
