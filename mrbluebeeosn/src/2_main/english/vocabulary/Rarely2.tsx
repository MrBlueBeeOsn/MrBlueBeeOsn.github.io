    ...
    <article>
        ...
        <div>
          ...
          <p className="margin-y-10">
            ...
            <span className="highlight-255-padding-3-6">
              ...
              <Link to="/tieng-anh/he-thong-7-dau-phu-phien-am-tieng-anh-1">rā̄rely</Link>/ 
              
              <sup>&nbsp;⬤• (2x)</sup>
              
            </span>
              
            &nbsp;là một trạng từ dùng để diễn tả một hành động, sự việc hoặc tình huống xảy ra không thường xuyên, ít khi hoặc hiếm có.
      ...
      <div className="margin-y-30 text-border1 table-container">
        ...
        <ul className="list-square">
          ...
          <li>"<strong>Rarely</strong>" thường đứng ở đầu câu hoặc trước động từ để bổ nghĩa.</li>
