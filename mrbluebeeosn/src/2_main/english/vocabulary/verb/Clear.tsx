...
export default function Clear(): React.JSX.Element {
  ...
  <main className="image image2">
    ...
    <article>
      ...
      <p className="margin-top-20">Sơ đồ phối hợp mã mã nguồn [Clear]:</p>
      ...
      <p className="margin-top-20 text-indent-whole">Khi đặt vào sơ đồ vận hành, chính hình thái Động Cơ này sẽ hình thành nên các loại chức năng độc lập:</p>
      ...
      <p className="margin-top-20 text-indent-whole">Tầng 1 (Cấp tổng thể - [...]):</p>
        ...
        <ul className="list-square">
          ...
          <li>Hình thái: [Monitoring {'{how the program clears logs}'}] - Động Cụm [Verb Phrase] biểu thị dưới dạng một vùng mã mở rộng lớn bắt đầu bằng Thực Động Cơ [Action Verb Base] dạng đuôi "-ing" và kéo theo thành phần bổ trợ phía sau.</li>
      
          <li>Chức năng: [Monitoring {'{how the program clears logs}'}] - <strong>Danh Cụm</strong> [<strong>Noun Phrase</strong>] chịu trách nhiệm làm một vùng đầu việc lớn cần thực hiện, đảm nhận vai trò làm Danh Chủ [Subject] để thiết lập nền tảng thông tin đứng đầu toàn câu trước Thời Động Cơ "is".</li>
      ...
      <p className="margin-top-20 text-indent-whole">Tầng 2 (Cấp thành phần - {'{...}'}):</p>
        ...
        <ul className="list-square">
          ...
          <li>Hình thái: {'{how the program clears logs}'} - Động Câu [Verb Clause] định hình dưới dạng một khối mã con nằm gọn hoàn toàn bên trong vùng mã tổng thể, chứa đầy đủ Danh Chủ [Subject] riêng "the program" và Thời-Thực Động Cơ [Tense-Action Verb Base] riêng "clears" thiết lập theo trục thời hiện tại.</li>
      
          <li>Chức năng: {'{how the program clears logs}'} - Danh Câu [Noun Clause] đóng vai trò làm Danh Nhận [Object] chịu sự điều phối trực tiếp từ hạt nhân hành động "Monitoring" ở tầng ngoài, tích hợp chuỗi thông tin tiếp nhận hành động để làm rõ nội dung cho việc giám sát.</li>
      ...
      <p className="margin-top-20 text-indent-whole">Tầng 1 (Cấp tổng thể - [...]):</p>
        ...
        <ul className="list-square">
          ...
          <li>Hình thái: [about {'{how you clear the space}'}] - Giới Cụm [Prepositional Phrase] biểu thị dưới dạng một vùng mã lớn bắt đầu bằng Giới Cơ "about".</li>
      
          <li>Chức năng: [about {'{how you clear the space}'}] - <strong>Tính Cụm</strong> [<strong>Adjective Phrase</strong>] vận hành như một bộ lọc tổng thể đặt ngay phía sau để mô tả đặc điểm nội dung cho Danh Cụm "The instructions" đứng trước nó.</li>
      ...
      <p className="margin-top-20 text-indent-whole">Tầng 2 (Cấp thành phần - {'{...}'}):</p>
        ...
        <ul className="list-square">
          ...
          <li>Hình thái: {'{how you clear the space}'} - Động Câu [Verb Clause] định hình dưới dạng khối mã con nằm gọn bên trong, chứa Danh Chủ [Subject] "you" và Thực Động Cơ [Action Verb Base] "clear".</li>
      
          <li>Chức năng: {'{how you clear the space}'} - Danh Câu [Noun Clause] đóng vai trò làm Danh Nhận [Object] chịu sự điều phối trực tiếp của Giới Cơ "about" ở tầng ngoài.</li>
      ...
      <p className="margin-top-20 text-indent-whole">Tầng 1 (Cấp tổng thể - [...]):</p>
        ...
        <ul className="list-square">
          ...
          <li>Hình thái: [at {'{where they cleared the trees}'}] - Giới Cụm [Prepositional Phrase] biểu thị dưới dạng một vùng mã xác lập không gian lớn bắt đầu bằng Giới Cơ "at".</li>
      
          <li>Chức năng: [at {'{where they cleared the trees}'}] - <strong>Trạng Cụm</strong> [<strong>Adverb Phrase</strong>] đảm nhận vai trò làm một khối bối cảnh địa điểm tổng thể đứng sau bổ nghĩa cho hành động "pointed directly".</li>
      ...
      <p className="margin-top-20 text-indent-whole">Tầng 2 (Cấp thành phần - {'{...}'}):</p>
        ...
        <ul className="list-square">
          ...
          <li>Hình thái: {'{where they cleared the trees}'} - Động Câu [Verb Clause] định hình dưới dạng khối mã con nằm gọn bên trong, chứa Danh Chủ [Subject] riêng "they" và Thời-Thực Động Cơ [Tense-Action Verb Base] riêng "cleared" thuộc trục thời quá khứ.</li>
      
          <li>Chức năng: {'{where they cleared the trees}'} - Danh Câu [Noun Clause] đóng vai trò làm Danh Nhận [Object] chịu sự điều phối trực tiếp của Giới Cơ "at" ở tầng ngoài.</li>
