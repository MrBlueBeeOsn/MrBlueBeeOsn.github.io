		...
		<article>
			...
			<div className="example">
				...
				<p className="example-sentence text-center">
					...
					<span className="highlight-255-padding-0-4 text-border">
						<HashLink smooth to="#call-yoU-UP">call yoU UP</HashLink>
					</span> &nbsp;

					<span className="highlight-255-padding-0-4 text-border">
						<HashLink smooth to="#picK-UP">picK UP</HashLink>
					</span> &nbsp;
				...
				<p className="example-sentence text-center">
					<span className="highlight-255-padding-0-4 text-border" >
						<HashLink smooth to="#waKE-UP">waKE UP</HashLink>
					</span> &nbsp;

					<span className="highlight-255-padding-0-4 text-border">
						<HashLink smooth to="#geT-UP">geT UP</HashLink>
					</span> &nbsp;

					<span className="highlight-255-padding-0-4 text-border">
						<HashLink smooth to="#turn-ON">turn ... ON</HashLink>
					</span> &nbsp;

					<span className="highlight-255-padding-0-4 text-border" >
						<HashLink smooth to="#lookiNG-AFter">lookiNG AFter</HashLink>
					</span> &nbsp;

					<span className="highlight-255-padding-0-4 text-border">
						<HashLink smooth to="#pick-yoU-UP">pick yoU UP</HashLink>
					</span> &nbsp;

					<span className="highlight-255-padding-0-4 text-border">
						<HashLink smooth to="#pickED-UP">pickED UP</HashLink>
					</span> &nbsp;

					<span className="highlight-255-padding-0-4 text-border" >
						<HashLink smooth to="#giVE-UP2">giVE UP</HashLink>
					</span> &nbsp;

					<span className="highlight-255-padding-0-4 text-border">
						<HashLink smooth to="#ruN-OUT">ruN OUT</HashLink>
					</span> &nbsp;

					<span className="highlight-255-padding-0-4 text-border">
						<HashLink smooth to="#founD-OUT">founD OUT</HashLink>
					</span> &nbsp;

					<span className="highlight-255-padding-0-4 text-border" >
						<HashLink smooth to="#get-aLONG">get aLONG</HashLink>
					</span> &nbsp;

					<span className="highlight-255-padding-0-4 text-border">
						<HashLink smooth to="#haNG-OUT">haNG OUT</HashLink>
					</span> &nbsp;

					<span className="highlight-255-padding-0-4 text-border">
						<HashLink smooth to="#broKE-DOWN">broKE DOWN</HashLink>
					</span> &nbsp;

					<span className="highlight-255-padding-0-4 text-border" >
						<HashLink smooth to="#lookiNG-FORward">lookiNG FORward</HashLink>
					</span> &nbsp;

					<span className="highlight-255-padding-0-4 text-border">
						<HashLink smooth to="#puT-OFF">puT OFF</HashLink>
					</span> &nbsp;

					<span className="highlight-255-padding-0-4 text-border">
						<HashLink smooth to="#takeS-AFter">takeS AFter</HashLink>
					</span> &nbsp;

					<span className="highlight-255-padding-0-4 text-border" >
						<HashLink smooth to="#came-aCROSS">came aCROSS</HashLink>
					</span> &nbsp;

					<span className="highlight-255-padding-0-4 text-border">
						<HashLink smooth to="#called-the-WEDdiNG-OFF">called ... OFF</HashLink>
					</span> &nbsp;

					<span className="highlight-255-padding-0-4 text-border">
						<HashLink smooth to="#cheeR-UP">cheeR UP</HashLink>
					</span> &nbsp;

					<span className="highlight-255-padding-0-4 text-border" >
						<HashLink smooth to="#drop-mE-OFF">drop mE OFF</HashLink>
					</span> &nbsp;

					<span className="highlight-255-padding-0-4 text-border">
						<HashLink smooth to="#geT-Over">geT Over</HashLink>
					</span> &nbsp;

					<span className="highlight-255-padding-0-4 text-border">
						<HashLink smooth to="#looK-INto">looK INto</HashLink>
					</span> &nbsp;

					<span className="highlight-255-padding-0-4 text-border" >
						<HashLink smooth to="#maDE-UP">maDE UP</HashLink>
					</span> &nbsp;

					<span className="highlight-255-padding-0-4 text-border">
						<HashLink smooth to="#turnS-UP">turnS UP</HashLink>
					</span> &nbsp;

					<span className="highlight-255-padding-0-4 text-border">
						<HashLink smooth to="#catCH-UP">catCH UP</HashLink>
					</span> &nbsp;

					<span className="highlight-255-padding-0-4 text-border" >
						<HashLink smooth to="#cuT-DOWN">cuT DOWN</HashLink>
					</span> &nbsp;
					...
					<span className="highlight-255-padding-0-4 text-border">
						<HashLink smooth to="#holD-ON">holD ON</HashLink>
					</span> &nbsp;

					<span className="highlight-255-padding-0-4 text-border">
						<HashLink smooth to="#let-mE-DOWN">let mE DOWN</HashLink>
					</span> &nbsp;

					<span className="highlight-255-padding-0-4 text-border">
						<HashLink smooth to="#seT-UP">seT UP</HashLink>
					</span> &nbsp;

					<span className="highlight-255-padding-0-4 text-border">
						<HashLink smooth to="#tooK-OFF">tooK OFF</HashLink>
					</span> &nbsp;

					<span className="highlight-255-padding-0-4 text-border">
						<HashLink smooth to="#worK-OUT">worK OUT</HashLink>
					</span> &nbsp;
				...
				<p className="example-sentence text-center">
					...
					<span className="highlight-255-padding-0-4 text-border">
						<HashLink smooth to="#waKE-UP2">waKE UP</HashLink>
					</span> &nbsp;

					<span className="highlight-255-padding-0-4 text-border">
						<HashLink smooth to="#geT-UP2">geT UP</HashLink>
					</span> &nbsp;
					...
					<span className="highlight-255-padding-0-4 text-border">
						<HashLink smooth to="#eaT-OUT">eaT OUT</HashLink>
					</span> &nbsp;

					<span className="highlight-255-padding-0-4 text-border">
						<HashLink smooth to="#cheeR-UP2">cheeR UP</HashLink>
					</span> &nbsp;

					<span className="highlight-255-padding-0-4 text-border">
						<HashLink smooth to="#calM-DOWN">calM DOWN</HashLink>
					</span> &nbsp;

					<span className="highlight-255-padding-0-4 text-border">
						<HashLink smooth to="#broKE-DOWN2">broKE DOWN</HashLink>
					</span> &nbsp;

					<span className="highlight-255-padding-0-4 text-border">
						<HashLink smooth to="#geT-Over2">geT Over</HashLink>
					</span> &nbsp;

					<span className="highlight-255-padding-0-4 text-border">
						<HashLink smooth to="#haNG-OUT2">haNG OUT</HashLink>
					</span> &nbsp;

					<span className="highlight-255-padding-0-4 text-border">
						<HashLink smooth to="#catCH-UP2">catCH UP</HashLink>
					</span> &nbsp;

					<span className="highlight-255-padding-0-4 text-border">
						<HashLink smooth to="#get-aLONG2">get aLONG</HashLink>
					</span> &nbsp;

					<span className="highlight-255-padding-0-4 text-border">
						<HashLink smooth to="#gO-OUT">gO OUT</HashLink>
					</span> &nbsp;

					<span className="highlight-255-padding-0-4 text-border">
						<HashLink smooth to="#founD-OUT2">founD OUT</HashLink>
					</span> &nbsp;

					<span className="highlight-255-padding-0-4 text-border">
						<HashLink smooth to="#get-aLONG3">get aLONG</HashLink>
					</span> &nbsp;

					<span className="highlight-255-padding-0-4 text-border">
						<HashLink smooth to="#tooK-UP">tooK UP</HashLink>
					</span> &nbsp;

					<span className="highlight-255-padding-0-4 text-border">
						<HashLink smooth to="#giVE-UP3">giVE UP</HashLink>
					</span> &nbsp;

					<span className="highlight-255-padding-0-4 text-border">
						<HashLink smooth to="#leveL-UP">leveL UP</HashLink>
					</span> &nbsp;
			...
			<p className="margin-top-20">Ví dụ:</p>
				...
				<ul className="list-square">
					...
					<li id="giVE-UP">Nhưng <strong>giVE UP</strong> = bỏ cuộc (không phải “cho lên” đâu nhé!)</li>
			...
			<h3 className="margin-y-50 text-center">Tại sao PHRAsal VERBS quan trọng trong năm 2026?</h3>
				...
				<ul className="list-square">
					...
					<li id="call-yoU-UP">Giao tiếp thực tế: Người bản xứ hầu như <strong>không nói</strong> “i will TELephone you.” mà nói “i’ll <strong>call</strong> yoU <strong>UP</strong>”.</li>
			
					<li id="picK-UP">Dễ gây nhầm lẫn nếu không biết: “<strong>picK UP</strong>” có thể là nhặt lên, học được, đón ai đó…</li>
			...
			<p className="margin-top-20"></p>
				...
				<ol>
					...
					<li value="1" id="waKE-UP">i Usually <strong>waKE UP</strong> at SEVen a.m. Even on WEEKends.</li>
					...
					<li value="15" id="came-aCROSS">i <strong>came aCROSS</strong> an OLD PHOto of us LAST NIGHT.</li>
					<li className="margin-bottom-20 list-none">Tôi <strong>tình cờ bắt gặp</strong> một bức ảnh cũ của chúng mình vào tối qua.</li>
			
					<li value="16" id="called-the-WEDdiNG-OFF">they <strong>called the WEDdiNG OFF</strong> at the LAST MINutes.</li>
					<li className="margin-bottom-20 list-none">Họ <strong>đã hủy đám cưới</strong> vào phút chót.</li>

					<li value="17" id="cheeR-UP"><strong>cheeR UP</strong>! THINGS will GET BETter.</li>
					<li className="margin-bottom-20 list-none"><strong>Vui lên đi</strong>! Mọi chuyện rồi sẽ khá hơn thôi.</li>
			
					<li value="18" id="drop-mE-OFF">can you <strong>drop mE OFF</strong> at the STAtion?</li>
					...
					<li value="19" id="geT-Over">it TOOK me MONTHS to <strong>geT Over</strong> the BREAKup.</li>
					<li className="margin-bottom-20 list-none">Tôi mất nhiều tháng mới <strong>vượt qua được</strong> vụ chia tay đó.</li>
			
					<li value="20" id="looK-INto">the MANager will <strong>looK INto</strong> the comPLAINT.</li>
					...
					<li value="21" id="maDE-UP">we ARGued but we <strong>maDE UP</strong> QUICKly.</li>
			...
			<p className="margin-top-20  text-indent-whole"><strong>DAIly rouTINE</strong>:</p>
				...
				<ul className="list-square">
					...
					<li id="waKE-UP2">i Usually <strong>waKE UP</strong> at SIX a.M. <strong>ever</strong>y DAY, EVEN on WEEKends.</li>
					<li className="margin-bottom-20 list-none">Tôi thường <strong>thức dậy</strong> lúc 6 giờ sáng mỗi ngày, kể cả vào cuối tuần.</li>
			
					<li id="geT-UP2"><strong>af</strong>ter the aLARM CLOCK RANG, it TOOK her TEN MINutes to FINally <strong>geT UP</strong>.</li>
					...
					<li id="turN-ON">PLEASE <strong>turN ON</strong> the AIR conDITioner be<strong>cause</strong> it is GETting VERy HOT in this ROOM.</li>
					<li className="margin-bottom-20 list-none">Làm ơn <strong>bật</strong> máy điều hòa lên vì trong phòng này đang rất nóng.</li>
			
					<li id="eaT-OUT">we are TOO TIred to COOK toNIGHT, so let's <strong>eaT OUT</strong> at that iTALian REStaurant.</li>
			...
			<p className="margin-top-20 text-indent-whole"><strong>FEELings</strong>:</p>
				...
				<ul className="list-square">
					...
					<li id="cheeR-UP2">she BOUGHT him his FAVORite ICE CREAM to <strong>cheeR UP</strong> <strong>af</strong>ter he FAILED his DRIving test.</li>
					...
					<li id="calM-DOWN">TAKE a DEEP BREATH and <strong>calM DOWN</strong> be<strong>fore</strong> you MAKE any HASty deCISions.</li>
					...
					<li id="broKE-DOWN2">she COULdn't hold BACK her eMOtions anyMORE and <strong>broKE DOWN</strong> in TEARS <strong>af</strong>ter HEARing the BAD NEWS.</li>
					...
					<li id="geT-Over2">it TOOK him a LONG TIME to <strong>geT Over</strong> the HEARTbreak of their BREAKup.</li>
			...
			<p className="margin-top-20 text-indent-whole"><strong>SOcial</strong>:</p>
				...
				<ul className="list-square">
					...
					<li id="gO-OUT">they deCIded to <strong>gO OUT</strong> for DINner and a MOvie to CELebrate their WEDding anniVERsary.</li>
			...
			<p className="margin-top-20 margin-bottom-20">3. <strong>Thực hành hàng ngày</strong> → Thay thế câu bình thường bằng PHRAsal VERBS:</p>
				...
				<ul className="list-square">
					...
					<li id="founD-OUT2">i <strong>founD OUT</strong> the TRUTH.</li>
			...
			<p className="margin-top-20 text-indent-whole">Part 1:</p>
				...
				<ul className="list-square">
					...
					<li id="get-aLONG3">i <strong>get aLONG</strong> WELL with my SIBlings.</li>
			...
			<p className="margin-top-20 text-indent-whole">Part 2:</p>
				...
				<ul className="list-square">
					...
					<li id="tooK-UP">LAST YEAR i <strong>tooK UP</strong> YOga to <strong>geT Over</strong> STRESS.</li>
			...
			<p className="margin-top-20 text-indent-whole">Part 3:</p>
				...
				<ul className="list-square">
					...
					<li id="giVE-UP3"><strong>man</strong>y PEOple <strong>giVE UP</strong> EAsily when THINGS GET TOUGH.</li>
					<li className="list-none">Nhiều người dễ dàng <strong>từ bỏ</strong> khi mọi thứ trở nên khó khăn.</li>
			...
			<p id="leveL-UP">Chúc bạn sớm “<strong>leveL UP</strong>” tiếng Anh với PHRAsal VERBS! 🚀</p>
