		...
		<article>
			...
			<p className="margin-top-20  text-indent-whole"><strong>DAIly rouTINE</strong>:</p>
				...
				<ul className="list-square">
					...
					<li>i Usually <strong>waKE UP</strong> at SIX a.M. <strong>ever</strong>y DAY, EVEN on WEEKends.</li>
					...
					<li>PLEASE <strong>turN ON</strong> the AIR conDITioner be<strong>cause</strong> it is GETting VERy HOT in this ROOM.</li>
			...
			<p className="margin-top-20 text-indent-whole">Part 3:</p>
				...
				<ul className="list-square">
					...
					<li><strong>man</strong>y PEOple <strong>giVE UP</strong> EAsily when THINGS GET TOUGH.</li>
