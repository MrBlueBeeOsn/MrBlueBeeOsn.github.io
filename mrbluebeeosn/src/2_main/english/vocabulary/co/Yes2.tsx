...
export default function YES2(): React.JSX.Element {
  ...
  <main className="image image2">
    ...
    <article>
      ...
      <p>Tuyệt vời! Chúng ta cùng khám phá sâu hơn về cách sử dụng từ "<strong>YES</strong>" (vâng) khi nó đóng vai trò là một ADverb trong tiếng Anh nhé.</p>
      ...
      <div className="margin-y-30 text-border1 table-container">
        ...
        <ul className="list-square">
          ...
          <li>Trong nhiều trường hợp, "<strong>YES</strong>" có thể được coi như một phần tử trong một cụm từ hơn là một ADverb độc lập.</li>
