...
export default function Certainly2(): React.JSX.Element {
  ...
  <main className="image image2">
    ...
    <article>
      ...
      <h4><HashLink smooth to="/vocabulary#tinh-chac-chan-terms"><mark className="highlight-tertiary-padding-4-8">ADverbs: chắc chắn</mark></HashLink></h4>
      ...
      <ol className="margin-top-30 padding-left-30">
        ...
        <li value="1">Certainly <strong>not</strong> /nɒt/</li>
        <li className="list-none">______, I would never do such a thing.</li>
        <li className="list-none margin-bottom-20">Chắc chắn là không, tôi sẽ không bao giờ làm việc đó.</li>

        <li value="2"><strong>Most</strong> certainly /məʊst/</li>
        <li className="list-none">______, I will be there to support you.</li>
        <li className="list-none margin-bottom-20">Chắc chắn rồi, tôi sẽ ở đó để ủng hộ bạn.</li>

        <li value="3"><strong>Quite</strong> certainly /kwaɪt/</li>
        <li className="list-none">He will ______ arrive on time.</li>
        <li className="list-none margin-bottom-20">Anh ấy chắc chắn sẽ đến đúng giờ.</li>

        <li value="4"><strong>Absolutely</strong> certainly /ˈsɜːrtnli/</li>
        <li className="list-none">This is ______ the right decision.</li>
        <li className="list-none margin-bottom-20">Đây chắc chắn tuyệt đối là quyết định đúng đắn.</li>

        <li value="5"><strong>More than</strong> certainly /mɔːr ðæn/</li>
        <li className="list-none">______, she will win the prize.</li>
        <li className="list-none margin-bottom-20">Hơn cả chắc chắn, cô ấy sẽ giành được giải thưởng.</li>

        <li value="6">Certainly <strong>know</strong> /noʊ/</li>
        ...
        <li value="7">Certainly <strong>believe</strong> /bɪˈliːv/</li>
        ...
        <li value="8">Certainly <strong>agree</strong> /əˈɡriː/</li>
        <li className="list-none">I ______ with your opinion.</li>
        <li className="list-none margin-bottom-20">Tôi chắc chắn đồng ý với ý kiến của bạn.</li>

        <li value="9">Certainly <strong>understand</strong> /ˌʌndəˈstænd/</li>
        <li className="list-none">I ______ your concerns.</li>
        <li className="list-none margin-bottom-20">Tôi chắc chắn hiểu những lo ngại của bạn.</li>

        <li value="10">Certainly <strong>possible</strong> /ˈpɒsəbl/</li>
        <li className="list-none">It is ______ to achieve your goals.</li>
