  ...
  <main className="image image2">
    ...
    <article>
      ...
      <ol className="margin-top-30 padding-left-30">
        ...
        <li value="4">the GARden was meTICulously mainTAINED, with EVERy PLANT PERfectly TRIMMED.</li>
        <li className="list-none margin-bottom-20">Khu vườn được chăm sóc tỉ mỉ, với từng cây đều được cắt tỉa hoàn hảo.</li>

        <li value="5">the PAINTing was meTICulously deTAILED, CAPturing EVERy NUance of the SUBject.</li>
