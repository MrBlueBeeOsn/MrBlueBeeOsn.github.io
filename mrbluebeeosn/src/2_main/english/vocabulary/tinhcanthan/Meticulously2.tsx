  ...
  <main className="image image2">
    ...
    <article>
      ...
      <div className="text-border1 padding-10 highlight-238-padding-4-8 bee-container">
        ...
        <div>
          ...
          <p className="margin-y-10">
            ...
            <strong>Meticulously&nbsp;</strong>
            
            <span className="highlight-255-padding-3-6">
              
              [meTICulously][me TIC u lous ly] /məˈtɪkjələsli/ + /
      ...
      <ol className="margin-top-30 padding-left-30">
        ...
        <li value="1">Meticulously <strong>planned</strong> /plænd/</li>
        <li className="list-none">She <strong>meticulously</strong> planned the party, making sure every detail was perfect.</li>
        ...
        <li value="2">Meticulously <strong>crafted</strong> /kræftɪd/</li>
        <li className="list-none">The watch was ______ by skilled artisans.</li>
        <li className="list-none margin-bottom-20">Chiếc đồng hồ được các nghệ nhân lành nghề chế tác một cách tỉ mỉ.</li>

        <li value="3">Meticulously <strong>researched</strong> /rɪˈsɜːtʃt/</li>
        <li className="list-none">The report was based on ______ data.</li>
        <li className="list-none margin-bottom-20">Báo cáo này dựa trên dữ liệu được nghiên cứu một cách tỉ mỉ.</li>

        <li value="4">Meticulously <strong>maintained</strong> /meɪnˈteɪnd/</li>
        <li className="list-none">The garden was ______, with every plant perfectly trimmed.</li>
        <li className="list-none margin-bottom-20">Khu vườn được chăm sóc tỉ mỉ, với từng cây đều được cắt tỉa hoàn hảo.</li>

        <li value="5">Meticulously <strong>detailed</strong> /ˈdiːteɪld/</li>
        <li className="list-none">The painting was ______, capturing every nuance of the subject.</li>
        <li className="list-none margin-bottom-20">Bức tranh được vẽ chi tiết tỉ mỉ, bắt trọn mọi sắc thái của chủ thể.</li>

        <li value="6">Meticulously <strong>observed</strong> /əbˈzɜːvd/</li>
        ...
        <li value="7">Meticulously <strong>recorded</strong> /rɪˈkɔːdɪd/</li>
        <li className="list-none">The historian ______ every detail of the event.</li>
        <li className="list-none margin-bottom-20">Nhà sử học ghi chép tỉ mỉ mọi chi tiết của sự kiện.</li>

        <li value="8">Meticulously <strong>prepared</strong> /prɪˈpeərd/</li>
        <li className="list-none">The chef ______ the meal, using only the freshest ingredients.</li>
        ...
        <li value="9">Meticulously <strong>assembled</strong> /əˈsembld/</li>
        <li className="list-none">The model was ______, following the instructions exactly.</li>
        <li className="list-none margin-bottom-20">Mô hình được lắp ráp tỉ mỉ, tuân theo chính xác hướng dẫn.</li>

        <li value="10">Meticulously <strong>inspected</strong> /ɪnˈspektɪd/</li>
        <li className="list-none">The engineer ______ the machine for any defects.</li>
